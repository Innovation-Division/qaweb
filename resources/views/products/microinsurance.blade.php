...
<p style="font-family: arial">
    ...
    <div class="top-container">
        ...
        <div class="custom-banner custom-page-banner" data-uri-path="/products/products-packages/microinsurance">
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 a-left">
                        <ul>
                             <li class="home"><a href="{{ url('/') }}" title="Go to Home Page">Home</a> <span
                            class="breadcrumbs-split"><i class="icon-keyboard_arrow_right"></i></span></li>
                               <li class="category4"><span> Products</span> </li>
                        <li class="category6"><span
                            class="breadcrumbs-split"><i class="fa fa-angle-right"></i></span></li>
                            ...
                            <li class="category63" style="font-family: arial;font-weight: normal;"><strong>Microinsurance</strong> </li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="main-container col1-layout">
        <div class="main container">
                        ...
                        <li class="item">
                            <div class="item-area box-shadow">
                                <div class="product-image-area">
                                    ...
                                    <a href="https://www.ucpbgen.com/quickview/index/view/id/49" class="quickview-icon">
                                        <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/microinsurance/kasambahay-protect"
                                            title="Kasambahay Protect" class="product-image" style="height: 219px;">
                                            <img id="product-collection-image-49" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/m/a/main---micro---kasambahay.jpg"
                                                alt="Kasambahay Protect" width="300">
                                        </a>
                                </div>
                                <div class="details-area" style="height: 122px;">
                                    <div class="product-name-wrapper abs">
                                        ...
                                        <h2 class="product-name">
                                            <a href="https://www.ucpbgen.com/products/products-packages/microinsurance/kasambahay-protect"
                                                title="Kasambahay Protect" style="font-family: arial">Kasambahay Protect </a>
                                        </h2>
                                    ...
                                    <div class="actions abs">
                                        <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=49" dataid="49"
                                            class="click-here inquiry col-md-12 col-sm-12 col-xs-12" title="INQUIRY">
                                            <!-- <i class="icon-cart"></i> -->
                                            <span style="font-family: arial" >&nbsp;INQUIRY </span></a>
                                        <div class="clearer">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="sorter">
                                <div class="sort-by">
                                    <label for="name">
                                        Sort By:</label>
                                    <select id="name">
                                        <option value="https://www.ucpbgen.com/products/products-packages/microinsurance?dir=asc&amp;order=position">
                                            Position </option>
                                        <option value="https://www.ucpbgen.com/products/products-packages/microinsurance?dir=asc&amp;order=name"
                                            selected="selected">Name </option>
                                        <option value="https://www.ucpbgen.com/products/products-packages/microinsurance?dir=asc&amp;order=viewproduct">
                                            Most Viewed </option>
                                    </select>
                                    <a href="https://www.ucpbgen.com/products/products-packages/microinsurance?dir=desc&amp;order=name"
            ...
            <select id="limit">
                            <option value="https://www.ucpbgen.com/products/products-packages/microinsurance?limit=100" selected="selected">
                    100                </option>
                            <option value="https://www.ucpbgen.com/products/products-packages/microinsurance?limit=all">
                    All                </option>
                        </select>
        </div> -->
                            </div>
                    ...
                    <div class="col-sm-6 col-xs-11 login-wrap">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in" id="epolicy" role="tabpanel">
                                ...
                                <input name="form_key" type="hidden" value="MKSJDSLVZGCHZqqB">
