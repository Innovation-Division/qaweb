<div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="col-md-12" style="margin-bottom:-15px;">
            <label id="lbl_claim_motor_pa_recovery_view">Is the with claim recovery?</label> 
            <input type="hidden" id="hd_claim_motor_pa_recovery_view" name="hd_claim_motor_pa_recovery_view">
        </div> 
        <div class="col-md-12 break-two"><br></div> 
        <div  class="col-md-12" >
            <button type="button" id="claim_motor_pa_recovery_yes_view" name="claim_motor_pa_recovery_yes_view" class="btn btnradiobutton" >Yes &nbsp;&nbsp;</button>
            <button type="button" id="claim_motor_pa_recovery_no_view" name="claim_motor_pa_recovery_no_view" class="btn btnradiobutton" >No &nbsp;&nbsp;</button>
        </div>
    </div>
    <div class="col-md-12 break-two"><br></div>
    <div class="col-md-12">
