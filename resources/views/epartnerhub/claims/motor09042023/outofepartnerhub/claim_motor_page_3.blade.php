<div class="col-md-12 break-two"><br></div>
    ...
    <div class="col-md-12">
        <div class="col-md-12" style="margin-bottom:-15px;">
            <label id="lbl_claim_recovery">Is the with claim recovery?</label> 
        </div> 
        <div class="col-md-12 break-two"><br></div> 
        <div  class="col-md-12" >
            <button type="button" id="claim_motor_recovery_yes" name="claim_motor_recovery_yes" class="btn" >Yes &nbsp;&nbsp;</button>
            <button type="button" id="claim_motor_recovery_no" name="claim_motor_recovery_no" class="btn" >No &nbsp;&nbsp;</button>
        </div>
    </div>
    <div class="col-md-12 break-two"><br></div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="col-md-4">
            <label>Year</label>
            <select  id="drpYear_claim_not" name="drpYear_claim_not" class="form-control dynamicyearclaimnot selectpicker drpYear_claim_not selectb5" data-style="input-lg drpYear_claim_not dynamicyear selectb5" data-size="10" data-live-search="true" style="font-family: muli; ">
                @if (old('drpYear_claim_not'))
                    <option value="{{ old('drpYear_claim_not') }}" style="display:none;opacity: 0.6;color: gray;" selected="selected" readonly value="">{{ old('drpYear_claim') }}</option>                                             
                @else
        ...
        <div class="col-md-4">
            <label>Brand</label>
            <select  id="brand_claim_not" name="brand_claim_not" class="form-control dynamicbrand_claim_not selectpicker brand_claim_not selectb5" data-style="input-lg brand_claim_not" data-size="10" data-live-search="true" style="font-family: muli" >
                @if (old('brand_claim_not'))
                    <option value="{{ old('brand_claim_not') }}" style="display:none;opacity: 0.6;color: gray;" selected="selected" readonly>{{ old('brand_claim_not') }}</option>                                             
                @else
        ...
        <div class="col-md-4">
            <label>Model</label>
            <select  id="model_claim_not" name="model_claim_not" class="form-control dynamic selectpicker model_claim_not selectb5" data-style=" input-lg model_claim_not" data-size="10" data-live-search="true"  style="font-family: muli">
                @if (old('model_claim_not'))
                    <option value="{{ old('model_claim_not') }}" style="display:none;opacity: 0.6;color: gray;" selected="selected" readonly>{{ old('model_claim_not') }}</option>                                             
                @else
    ...
    <div class="col-md-12">
        <div class="col-md-4 form-group">
            ...
            <input id="mv_file_no_claim" name="mv_file_no_claim" type="text" class="form-control input-lg" maxlength="100" value="{{ old('mv_file_no_claim') }}" >
        </div>
        <div class="col-md-4 form-group">
        ...
        <div class="col-md-4 form-group">
            ...
            <input id="engine_no_claim" name="engine_no_claim" type="text" class="form-control input-lg" maxlength="100" value="{{ old('engine_no_claim') }}" >
        </div>
    </div>
    <div class="col-md-12 break-two"><br></div>
    <div class="col-md-12">
        <div class="col-md-4 form-group">
            <label>Color</label>
            <input id="color_claim" name="color_claim" type="text" class="form-control input-lg" maxlength="100" value="{{ old('color_claim') }}" >
        </div>
        <div class="col-md-4 form-group">
            <label>Chassis No.</label>
            <input id="chassis_no_claim" name="chassis_no_claim" type="text" class="form-control input-lg" maxlength="100" value="{{ old('chassis_no_claim') }}" >
        </div>
        <div class="col-md-4 form-group">
            <label>Conduction Sticker No.</label>
            <input id="conduction_sticker_no_claim" name="conduction_sticker_no_claim" type="text" class="form-control input-lg" maxlength="100" value="{{ old('conduction_sticker_no_claim') }}" >
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="col-sm-4">
                <button type="submit" id="clm_motor_submit_standalone" name="clm_motor_submit_standalone"   class="btn btn-secondary clm_motor_submit_standalone">Submit</button>
        </div>      
    </div>
