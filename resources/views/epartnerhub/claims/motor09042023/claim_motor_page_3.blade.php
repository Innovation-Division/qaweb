<div class="col-md-12 break-two"><br></div>
    ...
    <div class="col-md-12">
        <div class="col-md-4">
            <label>Year</label>
            <select  id="drpYear_claim" name="drpYear_claim" class="form-control dynamicyearclaim selectpicker drpYear_claim selectb5" data-style="input-lg drpYear_claim dynamicyear selectb5" data-size="10" data-live-search="true" style="font-family: muli; ">
                @if (old('drpYear_claim'))
                    <option value="{{ old('drpYear_claim') }}" style="display:none;opacity: 0.6;color: gray;" selected="selected" readonly value="">{{ old('drpYear_claim') }}</option>                                             
                @else
        ...
        <div class="col-md-4">
            <label>Brand</label>
            <select  id="brand_claim" name="brand_claim" class="form-control dynamicbrand_claim selectpicker brand_claim selectb5" data-style="input-lg brand_claim" data-size="10" data-live-search="true" style="font-family: muli" >
                @if (old('brand_claim'))
                    <option value="{{ old('brand_claim') }}" style="display:none;opacity: 0.6;color: gray;" selected="selected" readonly>{{ old('brand_claim') }}</option>                                             
                @else
        ...
        <div class="col-md-4">
            <label>Model</label>
            <select  id="model_claim" name="model_claim" class="form-control dynamic selectpicker model_claim selectb5" data-style=" input-lg model_claim" data-size="10" data-live-search="true"  style="font-family: muli">
                @if (old('model_claim'))
                    <option value="{{ old('model_claim') }}" style="display:none;opacity: 0.6;color: gray;" selected="selected" readonly>{{ old('model_claim') }}</option>                                             
                @else
