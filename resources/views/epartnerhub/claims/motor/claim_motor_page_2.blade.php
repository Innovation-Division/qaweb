    ...
    <div class="col-md-12 form-group">
        <div class="col-md-12 form-group" style="margin-bottom:-15px;">
            <label id="lbl_third_party_motor">Is there a third party involved?</label> 
        </div> 
        <div class="col-md-12 break-two"><br></div> 
        <div  class="col-md-12 form-group" id="pwd_div_1">
            <button type="button" id="claim_motor_aget_yes" name="claim_motor_aget_yes" class="btn" >Yes &nbsp;&nbsp;</button>
            <button type="button" id="claim_motor_aget_no" name="claim_motor_aget_no" class="btn" >No &nbsp;&nbsp;</button>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="col-md-4 form-group">
            <label>Tel. No </label>
            <input id="tel_no_motor" name="tel_no_motor" type="text" class="form-control input-lg" maxlength="100" value="{{ old('tel_no_motor') }}"   >
        </div>
        <div class="col-md-4 form-group">
            <label>Mobile No</label>
            <input id="mobile_no_motor" name="mobile_no_motor" type="text" class="form-control input-lg" maxlength="100" value="{{ old('mobile_no_motor') }}" onkeydown="phoneMaskPHno()" maxlength="15" placeholder="(09XX) XXX-XXXX">
        </div>
        <div class="col-md-4 form-group">
            <label>Email Address</label>
            <input id="email_address_motor" name="email_address_motor" type="text" class="form-control input-lg" maxlength="100" value="{{ old('email_address_motor') }}">
        </div>
    </div>
    <div class="col-md-12 break-two"><br></div>
    <div class="col-md-12">
        <div class="col-md-8 form-group">
            ...
            <input id="no_passenger_motor" name="no_passenger_motor" type="text" class="form-control input-lg" maxlength="100" value="{{ old('no_passenger_motor') }}" >
        </div>
        <div class="col-md-4 form-group">
            <label>Name of Reportee</label>
            <input id="name_reportee_motor" name="name_reportee_motor" type="text" class="form-control input-lg" maxlength="100" value="{{ old('name_reportee_motor') }}">
        </div>
    </div>
