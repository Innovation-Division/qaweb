<div class="col-md-12 break-two"><br></div>
    ...
    <div class="col-md-12">
        <div class="col-md-4 form-group">
            <label>Year</label>
            <input id="drpYear_claim_not" name="drpYear_claim_not" type="text" class="form-control input-lg" maxlength="100" value="{{ old('drpYear_claim_not') }}" >
        </div>
        
        <div class="col-md-4 form-group">
            <label>Brand</label>
            <input id="brand_claim_not" name="brand_claim_not" type="text" class="form-control input-lg" maxlength="100" value="{{ old('brand_claim_not') }}" >
        </div>
        <div class="col-md-4 form-group">
