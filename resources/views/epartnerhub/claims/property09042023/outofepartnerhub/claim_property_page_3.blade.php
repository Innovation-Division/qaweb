    ...
    <div class="col-md-12">
        <div class="col-md-12" style="margin-bottom:-15px;">
            <label id="lbl_claim_motor_property_recovery">Is the with claim recovery?</label> 
            <input type="hidden" id="hd_claim_motor_property_recovery" name="hd_claim_motor_property_recovery">
        </div> 
        <div class="col-md-12 break-two"><br></div> 
        <div  class="col-md-12" >
            <button type="button" id="claim_motor_property_recovery_yes" name="claim_motor_property_recovery_yes" class="btn btnradiobutton" >Yes &nbsp;&nbsp;</button>
            <button type="button" id="claim_motor_property_recovery_no" name="claim_motor_property_recovery_no" class="btn btnradiobutton" >No &nbsp;&nbsp;</button>
        </div>
    </div>
    <div class="col-md-12 break-two"><br></div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="col-sm-4">
                <button id="clm_property_upload_new_not" name="clm_property_upload_new_not" type="submit"  class="btn btn-secondary">Submit</button>
        </div>      
    </div>
