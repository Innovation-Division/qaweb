                                    ...
                                    <div class="tab-pane fade in active" id="ecommerce" role="tabpanel">
                                        ...
                                        <input name="form_key" type="hidden" value="Jw9Lv4O4rXKWO6fq">
                                         <div class="registered-users mega-form-builds">
                                            <div class="content">
                                                <h1>
                                                   <span class="span-modal">Welcome to the</span>
                                                   <span class="span-modal">new COCOGEN website</span>
                                                </h1><p style="font-size: 11px;">To access your online account, please nominate a password below:</p>
                                                ...
                                                <ul class="form-list">
                                                    ...
                                                    <li class="forgot-password"><a href="{{ url('/epolicy')}}">
                                                        << Back to Login</a> </li>
                                                    <li class="e-policy-link"><span><p style="font-size: 11px;text-align: center;">*Your e-mail address serves as your username</p>.</span>
                                                    </li>
                                                </ul>
