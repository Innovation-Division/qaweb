                    ...
                    <div class="sign-in-form">
                        <div class="mt-0 mt-lg-3">
                            <div class="text-center">
                                <h2 class="mb-5 mrfs-1-2 mrfs-lg-1-12">Account Aldready Activated!</h2>
                            </div>
                            <p class="text-center">Your account is already activated. If you forgot your password. Click <a href="{{ route('forgotpassword') }}" class="forgot-link">here</a> to reset your password.</p>
