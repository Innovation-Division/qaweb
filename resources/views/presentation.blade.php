  ...
  <div class="category-name container">
                ...
                <div class="col-md-4" style="text-align: right;">
                    <a href="#partner-v" id="partner_tab" data-toggle="tab" class="btn btn-success btn-sm">Back</a>
                </div>
                <div class="col-md-4" style="text-align: right;">
                    <a href="#presentation-v" id="presentation_tab" data-toggle="tab" class="btn btn-success btn-sm">Back</a>
                </div>
            </div>
                ...
                <div class="col-main">
                    <div class="product-inquiry-form mega-form-builds" style="font-family: muli;line-height: ">
                        <form  class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div id="view_div" class="col-md-4 mt-4 text-right" style="margin-top: 20px;">
                                <a href="#" class="btn btn-primary btn-sm active" id="gridView"><i class="fa fa-th-large"></i></a>
                                <a href="#" class="btn btn-primary btn-sm" id="listView"><i class="fa fa-bars"></i></a>
                            </div>
