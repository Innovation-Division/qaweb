<div class="row" >
	<h4 class="rfs-2-5 rfs-md-1-3" style="text-align: left;">Additional Information</h4> <br>
</div>
...
<div class="row">
	<div class="col-md-4">
		<div class="form-group">
			<label for="status_4thpage">Status</label>
			<select  id="status_4thpage" name="status_4thpage" class="form-control selectpicker address_mobile input-lg selectb5" data-style="input-lg  btn-white-status_4thpage" data-size="10"  data-live-search="true" >
	...
	<div class="col-md-4">
		<div class="form-group">
			<label for="gender_4thpage">Gender</label> 
			<select  id="gender_4thpage" name="gender"  class="form-control selectpicker input-lg personal_ifno_mobile selectb5" data-style="input-lg  btn-white-gender" data-size="10">
					<option value="">- Select -</option>          
	...
	<div class="col-md-4">
		<div class="form-group">
			<label for="placeofbirth_4thpage">Place of Birth</label>
			<input name="placeofbirth_4thpage" id="placeofbirth_4thpage" type="text" class="form-control input-lg NoPaste personal_ifno_mobile" maxlength="500">
		</div>
	</div>
</div>  
...
<div class="row">
	<div class="col-md-4">
		<div class="form-group">
			<label for="sourceofFunds_4thpage">Source of Funds</label>
			<input name="sourceofFunds_4thpage" id="sourceofFunds_4thpage" type="text" class="form-control input-lg NoPaste personal_ifno_mobile" maxlength="500">
		</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
			<label for="occupation_4thpage">Occupation</label>
			<input name="occupation_4thpage" id="occupation_4thpage" type="text" class="form-control input-lg NoPaste personal_ifno_mobile" maxlength="500">
		</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
			<label for="tin_4thpage">TIN</label>
			<input name="tin_4thpage" id="tin_4thpage" type="text" class="form-control input-lg NoPaste personal_ifno_mobile" maxlength="500">
		</div>
	</div>
</div>  
...
<div class="row"> 
	<div class="col-md-4 col-md-4">
		<div class="form-group">
			<label for="employeer_4thpage">Employer</label>
			<input name="employeer_4thpage" id="employeer_4thpage" type="text" class="form-control input-lg NoPaste personal_ifno_mobile" maxlength="500">
		</div>
	</div>
</div>
