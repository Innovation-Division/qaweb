	...
	<div class="RowDialogBody p-4 px-5">
		...
		<div class="confirm-body row-dialog-hdr-success text-center">
			...
			<table class="table_modal">
                <tr>
                    <td class="text-start">
                        <label class="rfs-1-5 rfs-md-1 fw-normal">Thank you for choosing Cocogen Travel Excel Plus - Domestic for your trip. Before we proceed, please provide/confirm the following:</label>
                    </td>
                </tr>
            </table> 
            ...
            <div class="row"> 
                <div class="col-md-6" style="text-align: left;">
                    <div class="form-group">
                        ...
                        <input name="dateofBirth_personal_info" id="dateofBirth_personal_info"  type="text" class="form-control input-lg NoPaste validation_date_of_Birth_personal_info"  maxlength="100" placeholder="MM/DD/YYYY">
                    </div>
                </div>
            </div> 
            <style type="text/css">
                ...
                <div class="col-md-6"  style="text-align: left;">
                    <div class="form-group">
                       ...
                       <select  id="nationality_4thpage" name="nationality_4thpage" class="form-control address_mobile input-lg selectb5" data-style="input-lg  btn-white-nationality_4thpage" data-size="10"  data-live-search="true" readonly>
                                <option selected="selected" value="novalue" style="background-color: #ffffff;font-family: arial;">-- Select --</option>  
            ...
            <table class="table_modal">
                <tr>
                    <td class="text-start" colspan="3">
                        <label class="rfs-1-5 rfs-md-1 fw-normal">Travel Excel Plus - Domestic coverage only applies to the following:</label>
                    </td>
                    <td class="text-start">
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-start" width="20" >
                       <span style="margin-top:-35px !important;position: absolute">-</span> 
                    </td>
                     <td class="text-start" >
                ...
                <tr>
                    ...
                    <td class="text-start" width="20">
                        <span style="margin-top:-20px !important;position: absolute">-</span> 
                    </td>
                     <td class="text-start" >
        ...
        <div class="modal-dialog" style="max-width: 1250px; width: 100%;">
            <div class="modal-content">
                <div class="modal-header text-center">
                 ...
                 <div class="modal-body">
                    <div class="row">
                        <label for="Individual" style="color: #008080;">Benefits for Domestic Travel - VIA AIR PLAN</label>
                    </div>
                    <table style="border: 1px solid #008080;width: 100%;">
                        <tbody ><strong></strong>
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>PA COVERAGE</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Packet</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Pro</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Prime</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Platinum</strong></td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Accidental Death Disablement</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 250,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 500,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 750,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 1,000,000.00</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Accidental Medical Reimbursement</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 25,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 50,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 75,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 100,000.00</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Accidental Burial Benefit</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 25,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 50,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 75,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 100,000.00</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Unprovoked Murder and Assault</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 250,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 500,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 750,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 1,000,000.00</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;"><strong> Travel Assistance </strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;"></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;"></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;"></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;"></td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Medical expenses (with Sabotage and Terrorism) and hospitalization</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 250,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 500,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 750,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 1,000,000.00</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Transport of repatriation in case of illness or accident</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Pre-existing Condition within the Look Back Period</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 12,500.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 25,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 37,500.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 50,000.00</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Delayed departure</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 10,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 10,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 10,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 10,000.00</td>
                            </tr>
                            <tr>
                                ...
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 5,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 5,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 5,000.00</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 5,000.00</td>
                            </tr>
                             <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Compensation for in-flight loss and damage (checked-in baggage)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 10,000.00 
                                    (subject to Php 
                                    1,000.00/item)</td>  
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to Php 10,000.00 
                                    (subject to Php 
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Long distance medical information services</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Medical referral/appointment of local medical specialists</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                    ...
                    <div class="row">
                        <label for="Individual" style="color: #008080;">Benefits for Domestic Travel - VIA NON AIR PLAN (min 125k away from usual place of residence)</label>
                    </div>
                    <table style="border: 1px solid #008080;width: 100%;">
                        <tbody ><strong></strong>
                            <tr>
        ...
        <div class="modal-dialog" style="max-width: 1250px; width: 100%;">
            <div class="modal-content">
                <div class="modal-header text-center">
                 ...
                 <div class="modal-body">
                    <div class="row">
                        <label for="Individual" style="color: #008080;">Benefits for optional for COVID-19 Coverage (Via air or Via Non-Air)</label>
                    </div>
                    <table style="border: 1px solid #008080;width: 100%;">
                        <tbody ><strong></strong>
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>OPTIONAL COVER-COVID-19 COVERAGE (Via Air or Via Non-Air)</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Packet</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Pro</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Prime</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Platinum</strong></td>
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 250.00/day</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 500.00/day</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 750.00/day</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Php 1,000.00/day</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
