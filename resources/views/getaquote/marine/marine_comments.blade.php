                    @foreach($cocogen_marine_remarks as $comments)
                    <div >
                    ...
                    <button type="button" name="edit" id="{{ $comments->id }}" class="delete_comments btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button>
                    @endif
                    <hr/>
                    </div>
                    @endforeach