          ...
          <h2>Other Personal Data</h2>
           <div class="col-md-3">
            <label for="gender_other_personal_info">Gender</label>
              <select  id="gender" name="gender" class="form-control dynamicyear selectpicker select-input-border-gender" data-style="input-lg select-input-border-gender" data-size="10" data-live-search="true" style="font-family: muli; ">
            ...
            <div class="col-md-3">
                ...
                <select  id="civilstatus" name="civilstatus" class="form-control dynamicyear selectpicker select-input-border-civilstatus" data-style="input-lg select-input-border-civilstatus" data-size="10" data-live-search="true" style="font-family: muli; ">
                  <option value="" style="display:none;opacity: 0.6;color: gray;" selected="selected" readonly value="">- select - </option>
        ...
        <div class="col-md-3">
                ...
                <select  id="typeOfId" name="typeOfId" class="form-control dynamicyear selectpicker select-input-border-typeOfId" data-style="input-lg select-input-border-typeOfId" data-size="10" data-live-search="true" style="font-family: muli; ">
        <option value="" style="display:none;opacity: 0.6;color: gray;" selected="selected" readonly value="">- select - </option>
        <option value="Single">Single</option>            
        <option value="Married">Married</option>            
        <option value="Widowed">Widowed</option>            
        ...
        <div id="fromCopy" class="col-md-3">
            ...
            <div class="col-md-3" style="text-align: left;">
                    <br>
                    <button id="next_2ndpage" name="next_2ndpage" type="button" class="action next_2ndpage btn btn-default form-control current" style="min-height: 60px; color: rgb(255, 255, 255); display: block; background-color: rgb(0, 128, 128); margin-top: 3px;">Next &nbsp;&nbsp;<i class="fa fa-angle-right"></i></button>                        
                </div>
