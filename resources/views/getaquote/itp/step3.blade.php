				...
				<tfoot>
					...
					<tr>
						...
						<td class="text-color-dark" style="text-align: right;">
							...
							<input type="hidden" name="plus_all" id="plus_all" value="">
						</td>
					</tr>
					<tr>
						...
						<td class="text-color-dark" style="text-align: right;">
							...
							<input type="hidden" name="doc_stamp_all" id="doc_stamp_all" value="">
						</td>
					</tr>
					<tr>
						...
						<td class="text-color-dark" style="text-align: right;">
							...
							<input type="hidden" name="premium_tax_all" id="premium_tax_all" value="">
						</td>
					</tr>
					<tr>
					...
					<tr id="amountdue_tr_3rdpage">
						...
						<td class="text-color-dark" style="text-align: right;">
							...
							<input type="hidden" id="final_total_amount_all" name="final_total_amount_all" value="">
						</td>
					</tr>
					<tr id="promo_tr_3rdpage">
						<td colspan="2" class="text-color-dark" style="color: #008080  !important;font-style: italic;">Less %</td>
						<td class="text-color-dark" style="text-align: right;">
							<strong>-<span id="less" name="less" style="font-style: italic;"></span></strong>
							<input type="hidden" id="final_less_all" name="final_less_all" value="">
						</td>
					</tr>
					<tr>
                        ...
                        <td class="bgcolor-secondary text-color-light" style="text-align: right;">
							...
							<input type="hidden" id="total_amount_due_all" name="total_amount_due_all" value="">
						</td>
					</tr>
					<tr><td></td></tr>
					<tr>
                        ...
                        <td class="bgcolor-secondary text-color-light" style="text-align: right;">
							<strong>PHP <span id="convert_to_php" name="convert_to_php"></span></strong>
							<input type="hidden" name="convert_to_php_update" id='convert_to_php_update' value="">
							<input type="hidden" name="convert_date_now" id='convert_date_now' value="">
							
						</td>
					</tr>
						<td colspan="3" class="" >*Latest USD to PHP conversion will be applied at payment step.  <i>1 USD to <span id='exchangerate'></span> PHP</i></td>
					<tr>
