...
@if(session('message2') )
    ...
    <div class="container">
				<div class="" style="margin-top: 20px;">
                            <h3>Certificate of Registration Details</h3><br>
                            <small> &nbsp;Please correct the item/s below and authenticate your request to proceed or you may call us at (02) 8-830-6000</small>
                    ...
                    <div class="form-group" style="margin-top: 50px;margin-bottom: 50px;margin-left: 18px;">
                        <div class="col-md-12">
                            <div class="col-md-4 col-md-offset-4">
                               <button id="SecondTabButtonBack" name="SecondTabButtonBack" type="submit" class="form-control_ btn btn-secondary a-btn-slide-text_" value="default">Authenticate</button>  
                            </div>                            
                        </div>                                
                    </div>
                        <div class="col-md-12 break-two">
