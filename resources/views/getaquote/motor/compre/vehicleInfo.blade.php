...
<div class="container_">
  ...
  <div class="container_ row">           
    <div class="col-12 col-md-4">
      <div class="form-group {{ $errors->has('firstName') ? ' has-error' : '' }}">                           
        <div class="col-md-4_">
          <label class="b5-field-label" for="firstName">First Name *</label>
          <input id="firstName" type="text" class="form-control accessoryValue3 input-lg" name="firstName" maxlength="50" value="{{ old('firstName') }}" placeholder="" onkeypress="return /[a-z. ]/i.test(event.key)" pattern="[a-zA-Z/.]+" >
    ...
    <div class="col-12 col-md-4">
      <div class="form-group  {{ $errors->has('lastName') ? ' has-error' : '' }}">                           
        <div class="col-md-4_">
          <label class="b5-field-label" for="lastName">Last Name *</label>
          <input id="lastName" type="text" class="form-control input-lg" name="lastName" maxlength="50" value="{{ old('lastName') }}" placeholder="" onkeypress="return /[a-z. ]/i.test(event.key)" pattern="[a-zA-Z/.]+">
    ...
    <div class="col-12 col-md-4">
      <div class="form-group  {{ $errors->has('middleName') ? ' has-error' : '' }}">                           
        <div class="col-md-4_">
          <label class="b5-field-label" for="middleName">Middle Name *</label>
          <input id="middleName" type="text" class="form-control input-lg" name="middleName" maxlength="50" value="{{ old('middleName') }}" placeholder="" onkeypress="return /[a-z. ]/i.test(event.key)" pattern="[a-zA-Z/.]+">
  ...
  <div class="container_ row">               
    <div class="col-12 col-md-4">
      <div class="form-group  {{ $errors->has('contactNo') ? ' has-error' : '' }}">                           
        <div class="col-md-4_">
          <label class="b5-field-label" for="contactNo">Contact Number *</label>
          <input id="contactNo" type="text" class="form-control input-lg" maxlength="100" name="contactNo" value="{{ old('contactNo') }}" placeholder="" onkeypress="return isNumberKey(event)">
    ...
    <div class="col-12 col-md-4">
      <div class="form-group  {{ $errors->has('emailAddress') ? ' has-error' : '' }}">                           
        <div class="col-md-4_">
          <label class="b5-field-label" for="emailAddress">Email Address *</label>
          <input id="emailAddress" type="text" class="form-control input-lg" maxlength="50" name="emailAddress" value="{{ old('emailAddress') }}" placeholder="">
  ...
  <div class="">
    <h4 class="rfs-2-5 rfs-md-1-3">Car Information</h4>
  </div>
  ...
  <div class="container_ row">  
    ...
    <div class="col-12 col-md-4">
      <div class="form-group  {{ $errors->has('model') ? ' has-error' : '' }} fieldset-group has-feedback">
        <div class="col-md-4_">
          <label class="b5-field-label" for="model">Model *</label>
          <select  id="model" name="model" class="form-control dynamic selectpicker select-input-border-color-model selectb5" data-style=" input-lg select-input-border-color-model" data-size="10" data-live-search="true"  style="font-family: muli">
          @if (old('model'))
    ...
    <div class="col-12 col-md-4 ">                               
      <div class="form-group  {{ $errors->has('totalValue') ? ' has-error' : '' }} fieldset-group has-feedback">
        <div class="col-md-4_">
          ...
          <input id="totalValue" name="totalValue" type="text" class="form-control accessoryValue2 input-lg" maxlength="100" min="1" max="10" value="{{ old('totalValue') }}" placeholder="">
      ...
      <div class="form-group  {{ $errors->has('propertyDamage') ? ' has-error' : '' }} fieldset-group has-feedback">
        <div class="col-md-6_">
          <label for="propertyDamage">Property Damage</label>
            <select  id="propertyDamage" name="propertyDamage" class="form-control selectpicker selectb5 select-input-border-color-pd" data-style="input-lg select-input-border-color-pd" style="font-family: muli">                                        
  ...
  <div class="container_">  
    <div class="multi-field-wrapper">
      <div class="row mt-4 d-none d-md-flex">
        <div class="col-md-4"><label>Select Accessory *</label></div>
        ...
        <div class="multi-field row">
          <div class="col-12 col-md-4">
            <div class="select-form-wrapper">
              <!-- selectaccessory -->
                <label class="d-block d-md-none">Select Accessory *</label>
                <select id="accessory" name="accessory[]" class="form-control accesso select-input-border-color selectpicker selectb5" data-size="10" data-style=" select-input-border-color" data-live-search="true" >
          ...
          < /div> -->
          <div class="mt-3 mt-md-0 col-12 col-md-4 col-lg-3 d-flex align-items-end">
            <div class="select-form-wrapper flex-grow w-100">
              <label class="d-block d-md-none">Value *</label>
              <input id="accessoryValue" name="accessoryValue[]" type="text" class="form-control accessoryValue2 select-input-border-colo" data-style="input-lg select-input-border-color"  value=""  placeholder="">
            </div>
  ...
  <script type="text/javascript">
    ...
    jQuery('.multi-field-wrapper').each(function() {
      ...
      jQuery(".add-field", jQuery(this)).click(function(e) {
        ...
        jQuery('.multi-field .accesso').selectpicker("refresh");
      });
      ...
      jQuery('.multi-field .remove-field', $wrapper).click(function() {
        ...
        if (jQuery('.multi-field', $wrapper).length < 2){
          jQuery('.multi-field .remove-field').hide();
        }
      });
    });
  ...
  <div class="text-center mt-4">                                  
    <input type="submit" id="ViewQuote" name="ViewQuote" class="form-control_ btn btn-lg_ btn-secondary a-btn-slide-text_ btn-buy" value="View Quote">
