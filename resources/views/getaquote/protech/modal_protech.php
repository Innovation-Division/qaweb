<div class="summary-and-confirmation-slider summary-and-confirmation-motor b5form">
                ...
                <div class="modal-body">
                    ...
                    <ol>
                        <li>
                            ...
                            <p>Cocogen information services are available for information purposes only. The publication
                            and posting of any content and access to any of the Cocogen information services
                            do not constitute, either explicitly or implicitly, any provision of services or
                            products by us. Information concerning Cocogen products or services is only available
                            from the relevant Cocogen companies</p>
                        </li>
                        <li>
    ...
    <div class="modal fade bs-example-modal-lg modal-light" id="exclusionslimitations" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
