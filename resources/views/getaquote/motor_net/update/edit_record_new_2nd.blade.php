...
<div class="container_">
    ...
    <div class="container_ row">
          ...
          <div class="form-group {{ $errors->has('brand') ? ' has-error' : '' }} fieldset-group has-feedback">
            <div class="col-md-4_">
              ...
              <select id="brand" name="brand" class="form-control dynamicbrand selectpicker select-input-border-color-brand selectb5" data-style="input-lg select-input-border-color-brand" data-size="10" data-live-search="true" style="font-family: muli">
                @if (old('brand'))
                  <option value="{{ old('brand') }}" selected="selected">{{ old('brand') }}</option>
                @else
              ...
              <input type="hidden" id="hiddenBrand" name="hiddenBrand" value="">
      ...
      <div class="col-md-4">
        ...
        <input id="seatNo" type="text" class="form-control integer input-lg" name="seatNo" maxlength="11" value="">
    </div>
    <input type='hidden' id='aonratenature' name='aonratenature' class='aonratenature' value="{{ $rateForAON }}">
    <div class="col-md-12_ break-two"><br></div>
    <div class="col-md-12_ break-two"><br></div>
      <input type="hidden" name="modelinfo" id='modelinfo' class='modelinfo'>
      <div class="col-12 col-md-4">
      ...
      <div class="col-12 col-md-4 ">
        <div class="form-group  fieldset-group has-feedback">
          <div class="col-md-4_">
            ...
            <input id="totalValue" name="totalValue" type="text" class="form-control  input-lg" maxlength="100" min="1" max="10" placeholder="">
            <input type="hidden" name="totalValuehid" class="form-control totalValuehid" id="totalValuehid">
          </div>
    ...
    <div class="container_ row">
      <div class="col-12 col-md-4">
       ...
       <input type="hidden" name="bodyDropdown" id='bodyDropdown' class='bodyDropdown'>
        ...
        <input type="hidden" name="bodilyInjuryVal" id='bodilyInjuryVal' class='bodilyInjuryVal'>
      ...
      <div class="col-md-4">
          <div class="form-group">
              ...
              <div class="input-group">
                  <input name="grossPrem" id="grossPrem" type="text" class="form-control input-lg NoPaste personal_ifno_mobile" maxlength="100">
                  <input name="grossPrem1" id="grossPrem1" type="hidden">
              </div>
      ...
      <div class="form-group col-xs-8 col-md-8">
          ...
          <label for="actOfNature" style='margin-top:12px'> Act of Nature</label>
    ...
    <div class="RowDialogBody p-4 px-5">
      ...
      <div class="confirm-btn-panel mt-4">
        <div class="btn-holder text-center">
          <input type="button" id="btnCantFindCar_ok_car" name="btnCantFindCar" class="row-dialog-btn btn btn-secondary btn-md_ pl-3 pr-3" value="Ok" />
        </div>
        </div>
      </div>
  </div>
...
jQuery(document).ready(function($) {
  ...
  jQuery("#btnCantFindCar_ok_car").click(function () {
...
<script type="text/javascript">
  $(window).on('load', function() {
    ...
    var uriId = window.location.pathname.split('/').pop();

    // Set the value of the "transno" input field to the URI ID
    $('#transno').val(uriId);
  });
        ...
        $(document).ready(function() {
            $('#grossPrem').change(function(e) {
                ...
                var valuesAccesory = $("input[name='device_access_value[]']").map(function(){
                    ...
                    var minODT = 0.01 *  parseFloat(totalValCompute)
