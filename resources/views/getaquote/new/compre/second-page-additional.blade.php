        ...
        <div class="row">
            <div class="col-12 personal-div">
                ...
                <p class="text-center" style="font-size: 17px; line-height: 24px; font-weight: 600;">You can find car
                    information <a href="javascript:void(0)" style="color: #E4509A;" id="showModal" data-toggle="modal"
                        data-target="#informationHere">here</a></p>
            ...
            <div class="col-12 text-center personal-input-div">
                <div class="row justify-content-center">
                    <div class="col-lg-4 mb-5 personal-input">
                        ...
                        <input type="text" name="mvFileNo" maxlength="50" id="mvFileNo"
                            value="{{$addtlcarinfo->mvFileNo}}" placeholder="Enter mv file no"
                    ...
                    <div class="col-lg-4 mb-5 personal-input">
                        ...
                        <input type="text" name="engineNo" id="engineNo" maxlength="50"
                            value="{{$addtlcarinfo->engineNo}}" placeholder="Enter engine no."
                            style="background-color: #F5F5F5;">
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-4 mb-5 personal-input">
                        ...
                        <div class="dropdown dropdown-customize">
                            <input type="hidden" name="bodyType" id="bodyType" value="{{$addtlcarinfo->bodyType}}">
                            <button class="btn dropdown-toggle" type="button" data-toggle="dropdown">
                                @if($addtlcarinfo->bodyType)
                                <p class="p-dropdown-select">{{$addtlcarinfo->bodyType}}</p>
                                @else
                                <p class="p-dropdown-select">Select Body Type</p>
                                @endif
                            </button>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="javascript:void(0)"
                                        class="dropdown-select {{$addtlcarinfo->bodyType === 'Convertible' ? 'dropdown-select-active' : '' }}">Convertible</a></li>
                                <li><a href="javascript:void(0)"
                                        class="dropdown-select {{$addtlcarinfo->bodyType === 'Coupe' ? 'dropdown-select-active' : '' }}">Coupe</a></li>
                                <li><a href="javascript:void(0)"
                                        class="dropdown-select {{$addtlcarinfo->bodyType === 'Hatchback' ? 'dropdown-select-active' : '' }}">Hatchback</a></li>
                                <li><a href="javascript:void(0)" 
                                        class="dropdown-select {{$addtlcarinfo->bodyType === 'MPV or Minivan' ? 'dropdown-select-active' : '' }}">MPV or Minivan</a></li>
                                <li><a href="javascript:void(0)" 
                                        class="dropdown-select {{$addtlcarinfo->bodyType === 'Pick-up' ? 'dropdown-select-active' : '' }}">Pick-up</a></li>
                                <li><a href="javascript:void(0)"
                                        class="dropdown-select {{$addtlcarinfo->bodyType === 'Sedan' ? 'dropdown-select-active' : '' }}">Sedan</a></li>
                                <li><a href="javascript:void(0)"
                                        class="dropdown-select {{$addtlcarinfo->bodyType === 'Sport Utility Vehicle (SUV)' ? 'dropdown-select-active' : '' }}">Sport Utility Vehicle (SUV)</a></li>
                                <li><a href="javascript:void(0)"
                                        class="dropdown-select {{$addtlcarinfo->bodyType === 'Station Wagon' ? 'dropdown-select-active' : '' }}">Station Wagon</a></li>
                                <li><a href="javascript:void(0)"
                                        class="dropdown-select {{$addtlcarinfo->bodyType === 'Van' ? 'dropdown-select-active' : '' }}">Van</a></li>
                            </ul>
                        </div>
<!-- 
                        <input type="text" name="bodyType" id="bodyType" maxlength="50"
                            value="{{$addtlcarinfo->bodyType}}" placeholder="Enter body type"
                            style="background-color: #F5F5F5;"> -->
                    </div>
                    <div class="col-lg-4 mb-5 personal-input">
                        <p class="text-start p-label">
                    ...
                    <div class="col-lg-4 mb-5 personal-input">
                        ...
                        <input type="text" name="chasisNo" maxlength="50" id="chasisNo"
                            value="{{$addtlcarinfo->chassisNo}}" placeholder="Enter chassis no."
                            style="background-color: #F5F5F5;">
                    </div>
                </div>
                <div class="row justify-content-center mb-4">
                    <div class="col-lg-4 mb-5 personal-input">
                        ...
                        <input type="text" name="capacity" maxlength="2" id="capacity"
                            value="{{$addtlcarinfo->seatingNo}}" style="background: #f5f5f5 !important;"
                            placeholder="Enter seating capacity" disabled>
                    </div>
                    <div class="col-lg-4 mb-5 personal-input"><div class="form-group">
                            <p class="text-start p-label">Policy Inception Date<span class="text-danger">*</span></p>
                            <input id="policyDate" name="policyDate" value="{{$addtlcarinfo->inceptDate}}"
                                onkeydown="return false" type="text" placeholder="Policy Inception Date"
                                class="birdthday cp-spacing-input">
                            <svg class="icon-bday icon-bday-default" id="icon-bday-default"
                                xmlns="http://www.w3.org/2000/svg" width="12" height="13" fill="none"
                                viewBox="0 0 12 13">
                                <path fill="#309999"
                            ...
                            <svg class="icon-bday-checked d-none" id="icon-bday-checked"
                                xmlns="http://www.w3.org/2000/svg" width="12" height="13" fill="none"
                                viewBox="0 0 12 13">
                                <path fill="#309999"
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 mb-5 personal-input mortgage-div">
                        <p class="text-center mortgage-label" style="margin-left: 0px;">Mortgagee</p>
                ...
                <div class="row justify-content-center optionalMortgagee d-none">
                    <!-- <div class="col-lg-4 mb-5 personal-input">
                        <p class="text-start p-label">
                            Policy Inception Date<span class="text-danger">*</span></p>
                        <input type="date" name="policyDate" id="policyDate" placeholder="Enter mv file no"
                    ...
                    <div class="col-lg-4 mb-5 personal-input customize-none">
                     ...
                     <div class="col-lg-4 mb-5 personal-input optional-mortgagee-div customize-none">
                        <p class="text-start p-label optionalMortgagee d-none">
                            Mortgagee<span class="text-danger">*</span></p>
                        <input type="text" class="optionalMortgagee d-none" name="mortgagee" id="mortgagee"
                            maxlength="50" placeholder="Enter mortgagee" value="{{$addtlcarinfo->mortgagee_name}}"
                            style="background-color: #F5F5F5;">
                    </div>
                    <div class="col-lg-4 mb-5 personal-input customize-none">
                        ...
                        <div class="col-12 mb-4">
                            <ul class="nav nav-tabs" id="myTab" role="tablist" style="justify-content: center;">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link nav-modal active" id="home-tab" data-toggle="tab"
                                        data-target="#home" type="button" role="tab" aria-controls="home"
                                        aria-selected="true">Old</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link nav-modal" id="profile-tab" data-toggle="tab"
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade active text-center" id="home" role="tabpanel"
                                    ...
                                    <img src="{{ URL::to('/') }}/images/old-registration.png" class="old-registration"
                                        style="object-fit: cover; object-position: top;">
                                </div>
                                <div class="tab-pane fade text-center" id="profile" role="tabpanel"
                                    aria-labelledby="profile-tab">
                                    <img src="{{ URL::to('/') }}/images/new-registration.png" class="new-registration"
                                        style="object-fit: cover; object-position: top;">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 text-center">
                            <button class="btn-back rotatable" type="button" style="background-color: white;"
    ...
    $(document).ready(function () {
        ...
        $('#mvFileNo').change(function () {
            ...
            if (mvFileNo !== '' && plateNo !== '' && engineNo !== '' && bodyType !== '' && color !==
                '' && chasisNo !== '' && capacity !== '' && policyDate !== '' && $('#btnMortgagee')
                .val() !== 'default') {
        ...
        if ('{{$addtlcarinfo->mortgagee}}' === 'yes') {
            ...
            $('.optional-mortgagee-div').removeClass('customize-none');
            ...
            $('.optional-mortgagee-div').addClass('customize-none');
        } else {
...
<script>
    ...
    function populateYearbday() {
        ...
        yearSelectbday.value = minDate.getFullYear();
    }
