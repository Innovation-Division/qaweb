        ...
        <div class="row">
            ...
            <div class="col-12 text-center personal-input-div">
                <div class="row justify-content-center">
                    <div class="col-lg-4 mb-3 personal-input">
                        <input type="hidden" value="{{$trans_no}}" id="transNo" name="transNo">
                        <input type="hidden" value="firstPage" id="page" name="page">
                        <input type="hidden" value="edit" id="trans_status" name="trans_status">
                        <p class="text-start p-label">First Name<span class="text-danger">*</span></p>
                        <input type="text" placeholder="Enter your first name" maxlength="50" id="firstName" name="firstName" value="{{$personalInfo->firstName}}"
                            style="background-color: #F5F5F5;">
                    </div>
                    <div class="col-lg-4 mb-3 personal-input">
                        <p class="text-start p-label">
                            Surname<span class="text-danger">*</span></p>
                        <input type="text" placeholder="Enter your surname" maxlength="50" style="background-color: #F5F5F5;"
                            id="lastName" name="lastName">
                    </div>
                    <div class="col-lg-4 mb-3 personal-input">
                        <p class="text-start p-label">Suffix</p>
                        <div class="dropdown dropdown-customize">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="javascript:void(0)" class="dropdown-select {{$personalInfo->suffix === 'N/A' ? 'dropdown-select-active' : '' }}">N/A</a></li>
                                <li><a href="javascript:void(0)" class="dropdown-select {{$personalInfo->suffix === 'Jr' ? 'dropdown-select-active' : '' }}">Jr</a></li>
                                <li><a href="javascript:void(0)" class="dropdown-select {{$personalInfo->suffix === 'Sr' ? 'dropdown-select-active' : '' }}">Sr</a></li>
                                <li><a href="javascript:void(0)" class="dropdown-select {{$personalInfo->suffix === 'I' ? 'dropdown-select-active' : '' }}">I</a></li>
                                <li><a href="javascript:void(0)" class="dropdown-select {{$personalInfo->suffix === 'II' ? 'dropdown-select-active' : '' }}">II</a></li>
                                <li><a href="javascript:void(0)" class="dropdown-select {{$personalInfo->suffix === 'III' ? 'dropdown-select-active' : '' }}">III</a></li>
                                <li><a href="javascript:void(0)" class="dropdown-select {{$personalInfo->suffix === 'IV' ? 'dropdown-select-active' : '' }}">IV</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <section class="col-12" id="secondDiv">
        <div class="row">
            ...
            <div class="col-12 text-center car-information-input">
                <div class="row justify-content-center">
                    <div class="col-lg-4 mb-3 car-input">
                        <p class="text-start p-label">Brand<span class="text-danger">*</span></p>
                        <div class="dropdown dropdown-customize">
                            <input type="hidden" name="brand" id="brand">
                            <button class="btn dropdown-toggle" type="button" data-toggle="dropdown">
                                <p class="p-dropdown-select">{{$carInfo->brand}}</p>
                            </button>
                            <ul class="dropdown-menu">
                                <div class="input-icons" style="padding: 5px 15px;">
                                    <i class="fa fa-search icon" style=" padding: 10px 15px 20px 10px; min-width: 40px; color: #585858; transform: rotate(82deg); font-weight: 100; font-size: 14px;"></i>
                                ...
                                @foreach($brands as $brand)
                                    <li>
                                        <a href="javascript:void(0)" class="dropdown-select {{$brand->brand === $carInfo->brand ? 'dropdown-select-active' : '' }}">{{$brand->brand}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
            ...
            <button href="javascript:void(0)" class="btn-back" type="button"  id="cantFindModal"> I can't find my car</button>
            </div>
        </div>
    </section>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5 mb-3 non-input">
                            <p class="text-start p-label">
                             ...
                             <div class="dropdown dropdown-customize">
                                ...
                                <button class="btn dropdown-toggle" type="button" data-toggle="dropdown">
                                    <p class="p-dropdown-select">{{number_format($carInfo->bodilyInjury, 2)}}</p>
                                </button>
                                <ul class="dropdown-menu">
                                    <div class="input-icons" style="padding: 5px 15px;">
                                        <i class="fa fa-search icon" style=" padding: 10px 15px 20px 10px; min-width: 40px; color: #585858; transform: rotate(82deg); font-weight: 100; font-size: 14px;"></i>
                                    ...
                                    <li><a href="javascript:void(0)"
                                            class="dropdown-select {{$bi->amount === $carInfo->bodilyInjury ? 'dropdown-select-active' : '' }} d-none">{{number_format($bi->amount, 2)}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-5 mb-3 non-input">
                            ...
                            <div class="dropdown dropdown-customize">
                                ...
                                <button class="btn dropdown-toggle" type="button" data-toggle="dropdown">
                                    <p class="p-dropdown-select">{{number_format($carInfo->propertyDamage, 2)}}</p>
                                </button>
                                <ul class="dropdown-menu">
                                    <div class="input-icons" style="padding: 5px 15px;">
                                        <i class="fa fa-search icon" style=" padding: 10px 15px 20px 10px; min-width: 40px; color: #585858; transform: rotate(82deg); font-weight: 100; font-size: 14px;"></i>
                                    ...
                                    <li><a href="javascript:void(0)"
                                            class="dropdown-select {{$pd->amount === $carInfo->propertyDamage ? 'dropdown-select-active' : '' }} d-none">{{number_format($pd->amount, 2)}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-6 mb-5">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"
                                ...
                                <path stroke="#003592" fill="#ffffff"
...
<path d="M24.0586 2C28.2668 2 31.6783 5.29519 31.6783 9.36C31.6783 13.4248 28.2668 16.72 24.0586 16.72H2.23828" stroke="#003592" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" fill="#EFF2F4"/>
                    ...
                    <div class="col-lg-3 col-6 mb-5">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"
                                ...
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path stroke="#003592" fill="#ffffff" d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
                                <path stroke="#003592" fill="#ffffff" d="M12 12m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" />
            ...
            <div class="col-12 text-center standard-alert">
                <div class="row standard-alert-row">
                    <p style="margin: 0; text-align: start;">&nbsp;&nbsp;<svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="currentColor" class="bi bi-lightbulb-fill" viewBox="0 0 16 16">
                            <path fill="#54B947"
                        ...
                        </svg>&nbsp;&nbsp;&nbsp; Standard accessories are automatically covered by Auto Excel Plus
                        Insurance
                    </p>
                </div>
            </div>
    ...
    <section class="col-12" style="background-color: #F7FCFF">
        <div class="row">
            <div class="col-12 text-center non-standard">
                <p class="text-center div-sub-title">Non-Standard Accessories</p>
    ...
    <section class="col-12">
        <div class="row">
            <div class="col-12 total-guard">
                <p class="div-title text-center">Turbo Shield <svg xmlns="http://www.w3.org/2000/svg" width="56"
                        height="32" fill="#039855" class="bi bi-check-circle-fill" viewBox="0 0 24 24">
                        <path fill="#039855"
                            d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                    </svg></p>
            ...
            <div class="col-12 total-guard-buttons d-flex justify-content-center">
                <input type="hidden" name="buttonGuardValue" id="buttonGuardValue" value="no">
                <button class="btn-total-guard active-button-guard" id="noGuard">
    ...
    <section class="col-12">
        <div class="row">
            ...
            <div class="col-12 promo-code-buttons d-flex justify-content-center">
                <input type="hidden" name="buttonPromoValue" id="buttonPromoValue" value="no">
                <button class="btn-total-guard active-button-guard" id="noPromo">
                    <svg id="noGuardSvg" xmlns="http://www.w3.org/2000/svg" width="40" height="24" fill="currentColor"
                        class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                        <path fill="#ffffff"
                            d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
            ...
            <div class="col-12 d-none" id="promoCodeYes" style="background-color: #F7FCFF; height: 156px;">
                <div class="row mb-5">
...
<script>
    $(document).ready(function () {
        ...
        $("#buttonGuardValue").val('{{$carInfo->isWithTotalGuard}}');
        $("#brand").trigger('change').val('{{$carInfo->brand}}');
        $("#pd").trigger('change').val('{{$carInfo->propertyDamage}}');
        $("#bi").trigger('change').val('{{$carInfo->bodilyInjury}}');
        ...
        jQuery.ajax({
            ...
            success: function (result) {
                ...
                jQuery.each(result, function (key, value) {
                    var modelRep = value.model.replace('{{$carInfo->brand}}', '');
                    if('{{$carInfo->model}}' === modelRep) {
                        $('#modelOption').append($('<li><a href="javascript:void(0)" class="dropdown-select dropdown-select-active" title="'+modelRep+'">' + modelRep + '</a></li>'));
                    } else {
                        $('#modelOption').append($('<li><a href="javascript:void(0)" class="dropdown-select" title="'+modelRep+'">' + modelRep + '</a></li>'));
                    }
                })

                $('#modelOption').siblings('button').children('p').text('{{$carInfo->model}}');
                $('#modelOption').closest('.dropdown').find('button').addClass('button-background');
                $('#modelOption').closest('.dropdown').siblings('.p-label').css({
                        'background': '#F7FCFF'
                });
                ...
                jQuery.ajax({
                    ...
                    success: function (result) {
                        ...
                        jQuery.each(result, function (key, value) {
                            if('{{$carInfo->year}}' === value.year) {
                                $('#yearOption').append($('<li><a href="javascript:void(0)" class="dropdown-select dropdown-select-active" title="'+value.year+'">' + value.year + '</a><li>'));
                            } else {
                                $('#yearOption').append($('<li><a href="javascript:void(0)" class="dropdown-select" title="'+value.year+'">' + value.year + '</a></li>'));
                            }
                        });

                        $('#yearOption').closest('.dropdown').find('button > p').text('{{$carInfo->year}}');
                        $('#yearOption').closest('.dropdown').find('button').addClass('button-background');
                        $('#yearOption').closest('.dropdown').siblings('.p-label').css({
                            'background': '#F7FCFF'
                        });

                        $('#year').val('{{$carInfo->year}}');
                   ...
                   var final_val = Math.round((minval+maxval)/2)
                                ...
                                $("#quotationRange").val('{{$carInfo->fmvValue}}');
                                $("#total_value").val(addCommas('{{$carInfo->fmvValue}}'));

                                $("#pd").siblings('.dropdown-menu').children('li').children('a').each(function() {
                                    pd_value = $(this).text().split(",").join("");
                                    pd_value = Math.trunc(pd_value);
                                    if(parseFloat(pd_value) > parseFloat($("#total_value").val().split(",").join(""))) {
                                ...
                                $("#bi").siblings('.dropdown-menu').children('li').children('a').each(function() {
                                    ...
                                    if(parseFloat(bi_value) > parseFloat($("#total_value").val().split(",").join(""))) {
                                        $(this).addClass('d-none');
                                    }
                                });
                                ...
                                $("#total_value").change(function () {
                                    total = $("#total_value").val().split(",").join("");
                                ...
                                if (colCount > 1) {
                                    ...
                                    // $('.accessories_inputs').last().find("#accessory").val(accessories[0].accessory);
                                    // $('.accessories_inputs').last().find(".dropdown-toggle > p").text(accessories[0].accessory).trigger('change');

                                    // $('.accessories_inputs').last().find(".dropdown-toggle").addClass('button-background');
                                    // $('.accessories_inputs').last().find('.p-label').css({
                                    //     'background': '#F7FCFF'
                                    // });

                                    // $('.dropdown-select:contains(' + accessories[0].accessory +')').addClass('dropdown-select-active');
                                    // $('.accessories_inputs').last().find("#accessory_value").val(accessories[0].amount).trigger('change');
                                    ...
                                    $('.addItem').addClass('prev-add');

                                    var utcInstances = $('.accessories_inputs');

                                    utcInstances.each( (i, instance) => {
                                        $(instance).find(".dropdown").children('input').attr("id", function (e, oldVal) {
                                            if(i !== 0) {
                                                return 'accessory' + i;
                                            } else {
                                                return 'accessory';
                                        ...
                                        if(i !== 0) {
                                            $("#accessory" + i).val(accessories[i].accessory).trigger('change');
                                            $("#accessory_value" + i).val(accessories[i].amount).trigger('change');

                                            $("#accessory" + i).siblings("button").children('p').text(accessories[i].accessory).trigger('change');

                                            $("#accessory" + i).siblings('.dropdown-menu').children('li').children(".dropdown-select:contains(" + accessories[i].accessory +"):first").addClass('dropdown-select-active');

                                            $("#accessory" + i).siblings("button").addClass('button-background');
                                            $("#accessory" + i).closest('.dropdown').siblings('.p-label').css({
                                                'background': '#F7FCFF'
                                            });
                                            ...
                                            $("#accessory").val(accessories[0].accessory).trigger('change');
                                            $("#accessory_value").val(accessories[0].amount).trigger('change');

                                            $("#accessory").siblings("button").children('p').text(accessories[0].accessory).trigger('change');

                                            $("#accessory").siblings('.dropdown-menu').children('li').children(".dropdown-select:contains(" + accessories[0].accessory +"):first").addClass('dropdown-select-active');

                                            // if($("#accessory").siblings('.dropdown-menu').children('li').children(".dropdown-select").text().indexOf(accessories[0].accessory) >= 0) {
                                            //     $("#somediv").addClass("thisClass");
                                            // }

                                            $("#accessory").siblings("button").addClass('button-background');
                                            $("#accessory").closest('.dropdown').siblings('.p-label').css({
                                                'background': '#F7FCFF'
                                            });
                                        }
                                    ...
                                    $('.accessories_inputs').removeClass('mb-5').addClass('mb-2');
        ...
        if('{{$carInfo->promoCode}}') {
            ...
            $('#promoCode').val('{{$carInfo->promoCode}}').trigger('change');
            $("#promoAmount").html('P{{$carInfo->promoRate}}');
        ...
        $("body").on("click", ".addItem", function () {
            ...
            var $div = $('.accessories_inputs').last()
                .clone()
                .appendTo('#newinput')
                .find("input").attr("id", function (i, oldVal) {
                    if (colCount !== 1) {
                ...
                $('.accessories_inputs').last().find('button > p').text('Select Accessories')
        ...
        $("body").on("click", ".deleteItem", function () {
            ...
            if (colCount > 1) {
                ...
                jQuery('.deleteItem').addClass('d-none');
                jQuery('.accessories_inputs').find(".dropdown").children('input').attr("id", "accessory");
            ...
            if (jQuery(this).val() != '') {
                ...
                jQuery.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#yearOption').siblings('button').children('p').text('Select Year');
