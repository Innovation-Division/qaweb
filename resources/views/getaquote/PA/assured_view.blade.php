...
<input id="transno" name="transno" type="hidden" value="{{$cocogen_assured->id}}">
...
<div class="panel panel-primary">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="fname" name="fname" placeholder="*Enter First Name" value="{{$cocogen_assured->fname}}">
    </div>
    <label class="control-label col-sm-2" for="mi">*Middle Initial:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="mi" name="mi" placeholder="*Enter Middle Initial" value="{{$cocogen_assured->mi}}">
    </div>    
  </div>
   <div class="form-group">
    <label class="control-label col-sm-2" for="lname">*Last Name:</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="lname" name="lname" placeholder="Enter Last Name" value="{{$cocogen_assured->lname}}">
    </div>
  </div> 
    <div class="form-group">
    <label class="control-label col-sm-2" for="birthdate">*Date of Birth:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="birthdate" name="birthdate" placeholder="Select Date of Birth" value="{{$cocogen_assured->birthdate}}">
    </div>
    <label class="control-label col-sm-2" for="gender">*Gender:</label>
    <div class="col-sm-3">
          <select id="gender" name="gender" class="form-control">
          <option value="Male" <?php  if($cocogen_assured->gender=="Male")  {?> selected="selected" <?php }?> >Male</option>
          <option value="Female" <?php  if($cocogen_assured->gender=="Female")  {?> selected="selected" <?php }?> >Female</option>
          </select>
  </div>    
  </div> 
   <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="email" name="email" placeholder="Enter Email Address" value="{{$cocogen_assured->email}}" >
    </div>
  </div> 
  <div class="form-group">
    <label class="control-label col-sm-2" for="address">*Address:</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address" value="{{$cocogen_assured->address}}">
    </div>
  </div>
    <div class="form-group">
    <label class="control-label col-sm-2" for="landline">*Landline No.:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="landline" name="landline" placeholder="*Enter Landline" value="{{$cocogen_assured->landline}}"  onkeypress="return isNumber(event)">
    </div>
    <label class="control-label col-sm-2" for="cellphone">*Mobile No.:</label>
    <div class="col-sm-3">
          <input type="text" class="form-control" id="cellphone" name="cellphone" placeholder="*Enter Mobile No." value="{{$cocogen_assured->cellphone}}"  onkeypress="return isNumber(event)">
  </div>    
  </div>
    <div class="form-group">
    <label class="control-label col-sm-2" for="tin">*TIN:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="tin" name="tin" placeholder="*Enter TIN" value="{{$cocogen_assured->tin}}" onkeypress="return isNumber(event)">
    </div>    
  </div>             
...
$(document).ready( function (){
  ...
  $.ajaxSetup({
   ...
   $.ajax({
      url: "{{ url('/get-quote/assured-update')}}",
      method: "POST",
