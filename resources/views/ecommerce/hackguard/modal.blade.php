		...
		<div class="confirm-body row-dialog-hdr-success text-center">
            ...
            <div class="col-md-12" style="background-color: transparent !important;">
                <div class="col-md-12" style="background-color: transparent !important;">
                    <div class="form-group">
                        <label class="rfs-1-5 rfs-md-1 fw-normal modal-itp-content-text"> Hackguard only quotes clients who are 18 years old and above. 
                        <br>Before we proceed, please provide and confirm the following </label>
                ...
                <div class="col-md-12" style="background-color: transparent !important;">
                    <div class="col-md-11 form-group">
                        ...
                        data-style="btn-select" data-size="10"  data-live-search="false">
                            ...
                            <option class="option-design" value="Foreign Permanent Resident in the Philippines with Alien Certificate of Registration">Foreign Permanent Resident in the Philippines with Alien <br> Certificate of Registration</option>
            ...
            <div class="col-md-12" style="background-color: transparent !important;">
                <table id="tbl_iagree">
                    <tr>
                        <td>
                            <input id="chckIAGREE" name="chckIAGREE" class="" autocomplete="off" type="checkbox" style="width:20px !important;height:20px !important;padding:0px; margin-bottom:5px;">
                        </td>
                        <td>
                            <label for="chckIAGREE" class="rfs-1-5 rfs-md-1 fw-normal modal-itp-content-text-agree for-content-text"> I, hereby confirm that I am 18 years of age or older.</label>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="col-md-12" style="background-color:  #fff !important;">
            <div class="row">
                <div class="col-md-4  order-2 order-md-1  offset-md-2" >
                    <button id="modal-popup-first-page-cancel" type="button" class="btn-arrow-icon-secondary btn-arrow-icon-secondary-back btn form-control" data-dismiss="modal" style="font-size: 16px !important;">Cancel</button>
                </div>
                <div class="col-md-4  order-1 order-md-2">
                    <button id="modal-popup-first-page-confirm" type="button" class=" btn btn-primary form-control" disabled style="font-size: 16px !important;">Confirm</button>
                </div>
            </div>
        </div>
                ...
                <table class="table_modal">
                    <tr>
                        <td class="text-start" colspan="3"  style="pointer-events: none;">
                            <label class="rfs-1-5 rfs-md-1 fw-normal">Premium Hackguard Insurance coverage only applies to the following:</label>
                        </td>
...
<div id="modal-delete-upload" class="BlockUIConfirm confirm-modal" style="display:none">
	...
	<div class="RowDialogBody p-4 px-5" style="max-width: 35.75rem !important">
		...
		<div class="confirm-body row-dialog-hdr-success text-center">
            ...
            <div class="col-md-12" style="background-color: transparent !important;">
                <label for="" class="delete-photo-text"> Do you really want to delete the uploaded photo? <br>
            ...
            <div class="row">
                <div class="col-md-12" style="background-color:  #fff !important;">
                    <div class="col-md-12" style="background-color:  #fff !important;"> 
                        ...
                        <div class="col-md-4">
                                <button id="modal-delete-upload-cancel"  name="modal-delete-upload-cancel" autocomplete="off" type="button" class=" btn btn-primary form-control"> Cancel
                                </button>
                        </div>
                    </div>
                </div>
...
<div id="modal-payment-method" class="modal-payment-method confirm-modal" style="display:none" >
	<div class="blockui-mask"></div>
            ...
            <div class="col-md-12 payment-modal-body" style="background-color: transparent !important;">
                <table id="modal-payment-table" style="width:100%" class="table">
                    <tr>
                        ...
                        <td  style="width:80%;text-align:left;vertical-align: middle; font-family: 'Inter', sans-serif !important;" class="modal-payment-td-content" style="text-align: left;"> <label class="modal-payment-title">Proceed to payment</label><br>You are about to pay <strong><span class="quote_prem_dollar" style="font-family: 'Inter', sans-serif !important;"></span></strong> to Cocogen Insurance Inc., for <strong> <span class="quote-page-selected-promo" style="font-family: 'Inter', sans-serif !important;"></span>&nbsp;<span style="font-family: 'Inter', sans-serif !important;">Premium</span></strong>
                            <br>
                            <br>
                    ...
                    <div class="col-md-12 mb-0" style="background-color:transparent !important; margin-top:0px !important;">
                        <div class="row payment-buttons-row" style="width:80%; margin-left:20%;">
                        <div class="col-md-6">
                            <div class="form-group button-text-align-left">
                                <button id="payment-review-quote-button" name="payment-review-quote-button" type="button"  class="btn-arrow-icon-secondary button-secondary-default-des form-control" style="font-family: 'Inter', sans-serif !important;">No, review quote</button>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group button-text-align-left">
                                <button id="payment-proceed-to-payment" name="payment-proceed-to-payment" type="submit"  class="btn-arrow-icon btn-continue action next btn a-btn-slide-text_ form-control" style="width:auto; font-family: 'Inter', sans-serif !important;">Yes, proceed to payment</button>
                            </div>
                        </div>
                        </div>
                    </div>
...
<style>
  ...
  @media screen and (min-width: 799px) {
    ...
    #modal-popup-first-page-cancel::before,
    #modal-popup-first-page-cancel::after,
    #modal-popup-first-page-confirm::before,
    #modal-popup-first-page-confirm::after,
    #payment-review-quote-button::before,
    #payment-review-quote-button::after,
    #payment-proceed-to-payment::before,
    #payment-proceed-to-payment::after,
    #modal-fileupload-close::before,
    #modal-fileupload-close::after,
    #modal-delete-upload-confirm::before,
    #modal-delete-upload-confirm::after,
    #modal-delete-upload-cancel::before,
    #modal-delete-upload-cancel::after,
    #page1-back::before,
    #page1-back::after,
    #first_next::before,
    #first_next::after,
    #quotation_next::before,
    #quotation_next::after,
    #quotation_back::before,
    #quotation_back::after,
    #package_continue::before,
    #package_continue::after,
    #package_back::before,
    #package_back::after,
    #personal_info_next::before,
    #personal_info_next::after,
    #personal_info_back::before,
    #personal_info_back::after,
    #payb_back::before,
    #payb_back::after,
    #pay_now::before,
    #pay_now::after,
    #more_package_back::before,
    #more_package_back::after,
    #apply_plan_next::before,
    #apply_plan_next::after
     {
...
#modal-payment-table tr {
    display: flex;
    flex-direction: column;          
    align-items: center;
    width: 100%;
  }
  #modal-payment-table td {
    width: 100% !important;
    display: block;
  ...
  .payment-buttons-row .form-group {
    width: 100%;
    margin-bottom: 1rem;
  }
