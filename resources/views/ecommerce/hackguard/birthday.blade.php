<div class="col-md-2" style="position: relative;">
        <div class="form-group">
            ...
            <input  id="date-of-birth" name="date-of-birth" autocomplete="off" onkeydown="return false" type="text" placeholder="Date of Birth" class="birthday cp-spacing-input section-1-validation" style="cursor: pointer;">
...
<div id="date-picker-bday" class="date-picker-bday" style="position: absolute; display: none;">
        <div class="header">
    ...
    <script>
        ...
        const selectedDateInputsbday = document.querySelectorAll('.birthday'); 
            ...
            for (let day = 1; day <= daysInMonth; day++) {
                ...
                if (isDateDisabled(date)) {
                    ...
                    if (activeInputbday) {
                        ...
                        dateselectedbday = formattedDate;
                        $('#date-of-birth').val(formattedDate);

                        $(activeInputbday).trigger('change'); 
                        
                        document.querySelector('.icon-bday').style.display = 'none';
                        document.querySelector('.icon-bday-checked').style.display = 'inline';
        ...
        selectedDateInputsbday.forEach(input => {
            input.onfocus = () => {
               ...
               datePickerbday.style.top = `${input.offsetHeight + 4}px`; 
                datePickerbday.style.left = `0px`; 
