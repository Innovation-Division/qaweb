...
@endif
  ...
  <form method="post" action="{{ route('hackguardsave') }}" enctype="multipart/form-data">
    ...
    <input type="hidden" id="cyberbullying_amount" name="cyberbullying_amount" value="">
...
.summary-title-travel-price-breakdown-text{
  ...
  -webkit-overflow-scrolling: touch;
      ...
      .default_svg_check_package svg{
        height: 22px !important;
        width: 22px !important;
        margin-top: -1rem;
      }
        .svg-check-type1-default svg,
        .svg-check-type2-default svg{
...
<style>
  ...
  margin-top: 5px;
    ...
    #modal-popup-first-page-confirm:hover,
    #modal-delete-upload-cancel:hover,
    ...
    .btn-arrow-icon:hover:before {
      ...
      #page1-back:hover,
      #quotation_back:hover,
      #more_package_back:hover,
      #package_back:hover,
      #personal_info_back:hover,
      #payb_back:hover,
    ...
    #page1-back:focus,
 #quotation_back:focus,
 #more_package_back:focus,
      #package_back:focus,
      #personal_info_back:focus,
      #payb_back:focus,
...
switch (pkg.id) {
    case 'basic_cyber_ultra':
        $('#dollar-cyber-ultra-premium').text(formattedFinal).css(fontStyle);
        $('.dollar-cyber-ultra-premium').text(formattedFinal).css(fontStyle);
        break;
    case 'cyber_ultra':
        $('#piso-cyber-ultra-premium').text(formattedFinal).css(fontStyle);
        $('.piso-cyber-ultra-premium').text(formattedFinal).css(fontStyle);
        break;
    case 'basic_cyber_prime':
        $('#dollar-cyber-prime-premium').text(formattedFinal).css(fontStyle);
        $('.dollar-cyber-prime-premium').text(formattedFinal).css(fontStyle);
        break;
    case 'cyber_prime':
        $('#piso-cyber-prime-premium').text(formattedFinal).css(fontStyle);
        $('.piso-cyber-prime-premium').text(formattedFinal).css(fontStyle);
        break;
    case 'basic_cyberpro':
        $('#dollar-cyber-pro-premium').text(formattedFinal).css(fontStyle);
        $('.dollar-cyber-pro-premium').text(formattedFinal).css(fontStyle);
        break;
    case 'cyberpro':
        $('#piso-cyber-pro-premium').text(formattedFinal).css(fontStyle);
        $('.piso-cyber-pro-premium').text(formattedFinal).css(fontStyle);
        break;
    case 'basic_cybermax':
        $('#dollar-cyber-max-premium').text(formattedFinal).css(fontStyle);
        $('.dollar-cyber-max-premium').text(formattedFinal).css(fontStyle);
        break;
    case 'cybermax':
        $('#piso-cyber-max-premium').text(formattedFinal).css(fontStyle);
        $('.piso-cyber-max-premium').text(formattedFinal).css(fontStyle);
        break;
}
...
function ReplaceNumberWithCommas(x) {
  ...
  if (isPromoYes) {
    ...
    $(".default_svg_check_package").hide();
    $("#div-choose-package-mobile").show();
    $("#selected-premium-details").hide(); 

    $(".selectable-option").removeClass("selected active selected-option");
    $(".svg_check_type1, .svg_check_type2").hide();
    $(".selectable-option .default-svg").show();
    
   $(".svg-check-type1-default, .svg-check-type2-default").show();

    $("#svg_type1, #svg_type2, #default-svg").hide();
    $("#default-svg").show();
    $(".default_svg_check_package").show();
    ...
    selected.find(".default_svg_check_package").hide();
    ...
    $(this).addClass("selected-option active");
     ...
     if ($(this).data("cyberbullying") === "yes") {
        $(this).find(".svg_check_type2").show();
        $(this).find(".svg-check-type2-default").hide();
    } else {
        $(this).find(".svg_check_type1").show();
        $(this).find(".svg-check-type1-default").hide();
    }
    ...
    if (cyberbullying === 'yes') {
            $('#cyber-block, .cyber-display').show();

      const theftAmount = $('.summary-theft').first().text().trim();

        $("#summary-cyberbullying, .sum-cyberbullying").text(theftAmount);
        $('#cyberbullying_amount').val(theftAmount);
    } else {
        $('#cyber-block, .cyber-display').hide();
        $("#summary-cyberbullying, .sum-cyberbullying").text('');
        $('#cyberbullying_amount').val('0');
    }
...
<script>
    $(document).ready(function(){
      ...
      $("#first_next").click(function(e){
        ...
        let cleanedFirstName = firstNameInput.val().replace(/\s+/g, ' ').trim();
        firstNameInput.val(cleanedFirstName); 

        if (cleanedFirstName) {
            firstNameInput.removeClass("invalid").addClass("valid");
            firstNameInput.find('option').css('color', '#212529');
        } else {
            firstNameInput.removeClass("valid").addClass("invalid");
            errorPage1 = 1;
        }
          
        let lastNameInput = $("#last_name");
        let cleanedLastName = lastNameInput.val().replace(/\s+/g, ' ').trim(); 
        lastNameInput.val(cleanedLastName); 

          if (cleanedLastName) {
            lastNameInput.removeClass("invalid").addClass("valid");
            lastNameInput.find('option').css('color', '#212529');
        } else {
            lastNameInput.removeClass("valid").addClass("invalid");
            errorPage1 = 1;
        }
...
\
    ...
    if (selectedId) {
        if (cyberbullying) {
          ...
          $(this).find(".svg_check_type1, .svg_check_type2").hide();
          $(this).find(".svg-check-type1-default, .svg-check-type2-default").show();
      });
            $(".selectable-option").each(function () {
                ...
                if (optionId === selectedId && optionCyber === cyberbullying) {
                    ...
                    $(this).find(".svg_check_type2").show();
                    $(this).find(".svg-check-type2-default").hide();
                    $(this).find(".svg-check-type1-default").show();
                } else {
                    $(this).find(".svg_check_type1").show();
                    $(this).find(".svg-check-type1-default").hide();
                    $(this).find(".svg-check-type2-default").show();
                }
    ...
    $(this).find(".default_svg_check_package").hide();
      ...
      if (!cyberbullying) {
        ...
        $(this).find(".default_svg_check_package").show();
       $(this).find(".svg-check-type1-default, .svg-check-type2-default").show();
        $(this).find(".selected-premium-details").hide();
                $(this).find(".package-selected-button-get-plan")
                    .removeClass("package-selected-button-get-plan-selected")
