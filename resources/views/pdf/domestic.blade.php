...
<html>
  ...
  <body>
    ...
    <h6>DOMESTIC TRAVEL ({{$package}}) - COVID-19 COVERAGE ENDORSEMENT</h6>
    <p>TRIP CANCELLATION DUE TO COVID-19</p>
    <p>If Your trip is cancelled because Inter-Agency Task Force on Emerging Infectious Diseases (IATF) issued an advice against travel to your chosen destination due to Coronavirus Disease (COVID-19), We will pay up to the amount shown in the Policy Schedule for unused and non-refundable portion which have been paid in advance for the following</p>
    
    <p>a. Travel and accommodation expenses and pre-paid meal expenses which you paid or agreed to pay under a contract and which you cannot recover from any source;</p>
    <p>b. The cost of excursions, tours and activities which you paid for.</p>
    <p>The guarantee will only be valid if the travel insurance was bought at the same time as the trip covered or at least one (1) day prior to Your departure date provided that You have no knowledge of any unforeseeable circumstances that will possibly lead to cancellation of the trip.</p>
    
    <p>LIMIT - Php 25,000.00</p>
    <p>DAILY HOSPITAL BENEFIT DUE TO COVID-19</p>
    <p>This Policy extends to cover Your Daily Hospital Benefits should You be confined in a hospital or government-designated isolation facility due to COVID-19 during Your trip.</p>
    <p>We shall pay You, subject to the Daily Limit and limit on maximum number of days of hospital confinement, all stated in the Schedule.</p>
    <p>Provided always that We shall only be liable if during Your trip, You are tested positive of COVID-19 thru swab testing using the COVID-19 RT-PCR test and diagnosed by a qualified and licensed physician to undergo medical treatment on hospital or government-designated isolation facility. Evidence of hospitalization must be presented for claims evaluation. </p>
    <p>The benefit is extended up to fourteen (14) days upon arrival to the Usual Place of Residence provided COVID-19 was diagnosed during Your trip. If You are diagnosed with COVID-19 upon arrival, the benefit will not respond. </p>
    <p>LIMIT - Php {{$covid_a}} maximum of 15 days</p>
    
    <br><br><br><br>   <br><br><br><br>   <br><br><br><br>   <br><br><br><br>   <br><br>
    
    <div class="page_break"></div>
    <br><br><br><br>
    <h5 style="border-bottom: 1px dotted #000000;border-top: 1px dotted #000000;padding: 3px;margin-left: -6px;">GENERAL INFORMATION</h5>
