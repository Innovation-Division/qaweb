          ...
          <body>
           ...
           <main>
            <div style="margin-top:100px!important">
             ...
             <table style="width:100%;font-size:12px;padding-top: 320px!important" >
                <tr>
                ...
                <tr>
                 ...
                 <!-- <tr>
                  <td style="font-style: italic;">{{ $agentissue}}</td>
                </tr> -->
              </table>
   <!--          <style>
              .page_break{
            ...
            <table style="width:100%;font-size:10px:margin-left:10px;padding-top: -10px; font-family: Arial" border="0" >
              <tr>
                ...
                <tr>
                  ...
                  <td style="font-size: {{ strlen($insurred) > 30 ? '8px' : 'inherit' }}">:<strong>{{ $insurred }}</strong></td>
                ...
                <tr>
                  ...
                  <td style="font-size: {{ strlen($address) > 30 ? '8px' : 'inherit' }}">:{{$address}}</td>
                  <td>VAT </td>
                  <td style="text-align: right;"><span></span></td>
                  <td style="text-align: right;">{{$vat}}</td>
                </tr>
