    ...
    <div class="card" >
        <div class="card-body">
                    ...
                    <div class="col-md-12 d-flex justify-content-center  align-items-center">
                        ...
                        <path fill="#F5BC16" d="M33 10.156a24.375 24.375 0 1 0 24.375 24.375A24.403 24.403 0 0 0 33 10.156Zm0 44.688A20.313 20.313 0 1 1 53.313 34.53 20.335 20.335 0 0 1 33 54.844Zm11.593-31.906a2.033 2.033 0 0 1 0 2.874L34.437 35.968a2.032 2.032 0 0 1-2.874-2.874l10.156-10.156a2.03 2.03 0 0 1 2.874 0ZM24.875 4.063a2.031 2.031 0 0 1 2.031-2.032h12.188a2.031 2.031 0 0 1 0 4.063H26.906a2.031 2.031 0 0 1-2.031-2.032Z"/>
                        </svg>

                    </div>
                    <div class="col-md-12" style="line-height: 1rem;"><br> </div>
                    <div class="col-md-12 d-flex justify-content-center  align-items-center">
                        <label class="payment_pending_label">Payment Pending</label>
                    </div>
                    <div class="col-md-12" style="line-height: 1rem;"><br> </div>
                    <div class="col-md-12 text-center" style="line-height: 0.1rem;">
                        <label class="thank-you-for-choosing-cocogen-insurance">Thank you for completing your online transaction, you will receive a confirmation message once your payment has been processed.</label>
                    </div>
                    <div class="col-md-12" style="line-height: 1rem;"><br> </div>
                    <div class="col-md-12 text-center" style="line-height: 0.1rem;">
                        <label class="thank-you-for-choosing-cocogen-insurance"><b>Reference number is sent to your {{ request()->query('email') }}</b> </label>
                    </div>
                    <div class="col-md-12" style="line-height: 1rem;"><br> </div>
                    <div class="col-md-12 text-center" style="line-height: 0.1rem;">
        ...
        $(document).ready(function() {
            ...
            var interval = setInterval(function() {
                ...
                if (countdown < 0) {
                    ...
                    var targetUrl = "{{ url('/get-quote/ecommerce/pending') }}" + "/" + product;
