                ...
                <div class="card card-border-bottom">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div><label class="mdl-view-plan-value-field mdl-view-plan-airornonair"> {{ $data[0]['mode_transpo'] }}</label></div>
                        </div>
                        <div class="d-flex justify-content-between">
                ...
                <div class="card card-border-bottom">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div><label
                                    class="mdl-view-plan-value-field mdl-view-plan-house-no">{{ $data[0]['present_address'] }}
                                </label></div>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div><label class="mdl-view-plan-name-field">Street</label></div>
                            <div><label
                                    class="mdl-view-plan-value-field mdl-view-plan-street">{{ $data[0]['street'] }}
                                </label></div>
                        </div>
                        <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div style="width: 50%;"><label
                                    class="mdl-view-plan-value-field mdl-view-plan-region text-end">{{ $data[0]['region'] }}
                                </label></div>
                        </div>
