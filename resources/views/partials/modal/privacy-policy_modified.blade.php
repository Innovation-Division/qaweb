                ...
                <div class="h-100 position-relative">
                    <div class="d-flex align-items-center h-100">
                        <div class="text-center">
                            <h4 class="heading-border pb-1 mb-4 mrfs-1-8 mrfs-lg-2 mt-3">Your personal data belongs to you</h4>
                            ...
                            <div class="mt-4">
                                <div class="d-inline-block">
                                  <div class="form-check text-start">
                                      <input type="checkbox" class="form-check-input mt-2" id="ChckPrivacyPolicy" name="ChckPrivacyPolicy" value="1"  <?php if(old('ChckPrivacyPolicy')){ echo "checked";} ?>>
                                      <label for="ChckPrivacyPolicy" class="fw-normal form-check-label mrfs-1 mrfs-lg-1-5 text-left" style="width: 98%;  padding-left: 20px;"> I hereby confirm that I am aware of Cocogen's Privacy Policy</label>
                                  </div>
                                </div> 
                            </div>
                            <div class="agree_div_popup mt-4">
                                <a class="btn btn-primary-payment mb-3" href="#" id="cookiey">Agree </a>
                            </div>
                        </div>
                    </div>
                </div>
