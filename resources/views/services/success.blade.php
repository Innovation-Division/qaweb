                        ...
                        <div class="col-12 col-lg-10">
                            <div class="d-flex justify-content-center mb-4">
                                <div class="d-flex flex-column align-items-start mrfs-1 mrfs-lg-1-10">
                                    <h3 class="mrfs-1-13 mrfs-lg-2-5 mb-3">Payment Successful</h3>
                                    <p class="text-color-verydarkgray">Payment for your COCOGEN policy has been processed successfully!</p>
                                </div>
                            </div>
