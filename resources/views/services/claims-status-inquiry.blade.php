...
<div class="top-container">
    ...
    <div class="custom-banner custom-page-banner" data-uri-path="/services/claims-services/claims-status-inquiry">
    </div>
            ...
            <div class="row">
                <div class="col-sm-12 a-left">
                    <ul>
                        ...
                        <li class="category16" style="font-family: arial;font-weight: normal;"><span>Services</span> <span class="breadcrumbs-split"><i class="fa fa-angle-right">
                        </i></span></li>
                        <li class="category65"><span style="font-family: arial;font-weight: normal;">Claim Services</span> <span class="breadcrumbs-split"><i
                            class="fa fa-angle-right"></i></span></li>
                        <li class="category92" style="font-family: arial"><strong>Claim Status Inquiry</strong> </li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="main-container col1-layout">
    <div class="main container">
        <div class="col-main">
            ...
            <div class="row claim-status-inquiry-wrap product-essential">
                <div class="col-sm-8 col-xs-12 col-sm-offset-2 login-wrap">
                    <div class="tab-content">
                        <form action="" id="claim-status-inquiry-form" method="post">
                        <div class="registered-users mega-form-builds">
                            <div class="content">
                                <p class="text-center">
                                    Have you already completed your claims processing requirements and wish to follow
                                    up on your request? Keep track of your UCPB GEN claims by inputting the following
                                    data:</p>
                                <ul class="form-list">
                                    <li>
                                        <div class="input-box">
                                            <input class="text-center form-control required-entry validate-email" id="claims_reference_num"
                                                name="claim_reference_num" title="Claims Reference No" type="text"></div>
                                    </li>
                                    <li>
                                        <div class="input-box">
                                            <input class="text-center form-control input-text required-entry validate-password"
                                                id="pass" name="claim_reference_pass" title="Password *" type="password"></div>
                                    </li>
                                    <li>
                                        <button class="btn btn-default current" id="send2" name="send" title="" type="submit">
                                            SUBMIT</button></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-xs-12 netsol-site-seal text-center">
                    <p class="desc-title">
                        Note:</p>
                    <p>
                        For non-motor clients, you may use your Policy Number as your password.</p>
                    <p>
                        For motor clients, you may use either your Policy Number, Plate Number, or Motor
                        Number as your password.</p>
                </div>
                <div>
                    <div class="col-xs-12 product_details_info">
                        <div class="row">
                            <div class="col-md-12">
                                <p style="font-family: arial;">
                                    For more inquiries</p>
                                <p style="font-family: arial;">
                                    you can contact our Customer Service here</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a class="produt_click_here" href="/inquiries/customer-service/" style="font-family: arial;font-weight: normal;">inquire now</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <script type="text/javascript">                // <![CDATA[
                var dataForm = new VarienForm('ecommerce-login-form', true);
                // ]]></script>
