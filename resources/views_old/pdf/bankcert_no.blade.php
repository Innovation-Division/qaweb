...
<html>
  ...
  <body>
    ...
    <p>This is to confirm that the motor vehicle described below is coverd under Policy No. <strong> {{ $policyNo }}</strong> is issued by <strong>COCOGEN INSURANCE, INC.</strong></p>
