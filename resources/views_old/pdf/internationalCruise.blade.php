...
<html>
  ...
  <body>
    ...
    <div style="position: relative; z-index: 1; color: #000; padding: 20px;font-size:11px !important;top:123px;left:240px;font-weight:500">
        <p>{{$from_date}}</p>
    </div>

    <div style="position: relative; z-index: 1; color: #000; padding: 20px;font-size:11px !important;top:48px;left:400px;font-weight:500">
        <p>{{$to_date}}</p>
    </div>
    </div>
