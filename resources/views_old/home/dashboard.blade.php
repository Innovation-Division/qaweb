...
<style type="text/css">
    ...
    #SvgjsG1783 {
                fill: #ffffff !important; /* Change text color to white */
            }
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-end">
                               <div class="row">  
                               <p> Updated : <span class="clock" id="clock"> </span> 
                                        <span>{{date('F j, Y',strtotime('+8 hours'))}}  </span> </p>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a id="selectPol" class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 1 Month</a>
                          <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#" onclick="showPol(this)">Last 1 Year</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="progress progress-sm">
                      <div class="progress-bar bg-primary" style="width: 100%" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" aria-label="75% Complete">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a id="selectPrem" class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 1 Month</a>
                          <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#" onclick="showPremium(this)">Last 1 Year</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div id="1monthPremAmountAve" class="chart-xs" style="font-size:10px;margin-top:20px"> &#8369; {{$premium7DaysAve}} average amount per policy</div>
                    <div id="3monthPremAmountAve" class="chart-xs" style="font-size:10px;margin-top:20px"> &#8369; {{$premium30DaysAve}}0 average amount per policy</div>
                    <div id="1yrPremAmountAve" class="chart-xs" style="font-size:10px;margin-top:20px"> &#8369; {{$premium3MonthsAve}} average amount per policy</div>
                  </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a id="selectComm" class="dropdown-toggle " href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 1 Month</a>
                          <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#" onclick="showComm(this)">Last 1 Year</a>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="card-body">
            ...
            <div class="col-md-6 mb-3">
                    <a class="card card-link" href="{{url('/quotation/get-a-quote/first-page')}}">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center" style="height: 132px;">
                            <div class="card-title mb-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-file-plus">
                ...
                <a class="card card-link" href="{{url('/claims')}}">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center" style="height: 132px;">
                        <div class="card-title mb-1">
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="40"  height="40"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-device-tablet-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M11.5 21h-5.5a1 1 0 0 1 -1 -1v-16a1 1 0 0 1 1 -1h12a1 1 0 0 1 1 1v9.5" /><path d="M12.314 16.05a1 1 0 0 0 -1.042 1.635" /><path d="M15 19l2 2l4 -4" /></svg>
                        </div>
...
.apexcharts-pie-area:hover {  transform: scale(1.009, 1.009);
          color:inherit;
}
...
<style>
        ...
        <style>
          @media (max-width: 799px) {
            #chart-demo-pie,
            #chart-combination-quarter,
            #chart-combination-semester,
            #chart-combination {
