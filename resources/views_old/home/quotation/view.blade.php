    ...
    <div class="card card-lg" style="border-radius: 8px; " id="print-div">
        <div class="card-body" style="padding: 2rem !important;">
            <div class="row">
                ...
                <div class="col-12 my-2" style="background: #FFF4F9; padding:15px 15px 10px 15px; border-radius: 8px;">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <p style="font-weight: bold !important;" class="mb-2">{{$quotation->phone_number}}</p>
                            <p style="font-weight: bold !important;">{{$quotation->email_address}}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 text-end">
                    <p>₱ {{number_format($quotation->market_value)}}</p>
                </div>
                <div class="col-6">
                ...
                <div class="col-6 text-end">
                    <p>₱ {{number_format($quotation->net_premium, 2)}}</p>
                </div>
                <div class="col-6">
                ...
                <div class="col-6 text-end">
                    <p>₱ {{number_format($quotation->doc_stamps, 2)}}</p>
                </div>
                <div class="col-6">
                ...
                <div class="col-6 text-end">
                    <p>₱ {{number_format($quotation->gross_premium ,2)}}</p>
                </div>
                ...
                <div class="col-6 text-end my-3">
                    <p style="font-weight: bold;">₱ {{number_format($quotation->total_amount_due, 2)}}</p>
                </div>
                ...
                <div class="col-12" style="background: #F8F8F8; padding:20px; border-radius: 8px;">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <p>₱ {{number_format($quotation->bodily_injury ,2)}}</p>
                        </div>
                        <div class="col-6">
                            <p style="color: #888888;">Property Damage</p>
                        </div>
                        <div class="col-6 text-end">
                            <p>₱ {{number_format($quotation->property_damage ,2)}}</p>
                        </div>
                        <div class="col-6">
                            <p style="color: #888888;">Auto Personal Accident</p>
                        </div>
                        <div class="col-6 text-end">
                            <p>₱ {{number_format($quotation->pa, 2)}}</p>
                        </div>
                        <div class="col-6">
                            <p style="color: #888888;">Acts of Nature</p>
                        </div>
                        <div class="col-6 text-end">
                            <p>₱ {{number_format($quotation->aon_amount, 2)}}</p>
                        </div>
                        <div class="col-12">
