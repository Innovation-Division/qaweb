                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                <div class="form-group">
                                    <input type="hidden" value="{{$data->trans_no}}" id="trans_no">
                                    <input type="hidden" id="totalvalhid" name="totalvalhid">
                                    <input type="hidden" value="second" id="page" name="page">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="mb-2">MV File No. <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="mv_file" name="mv_file" placeholder="Enter mv file no.">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="mb-2">Plate No. <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="plate_no" name="plate_no" placeholder="Enter plate no.">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="mb-2">Body Type <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="body_type" name="body_type" placeholder="Enter body type">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-12 mb-2">
                                <div class="row">
                                    <input type="range" class="form-control-range" id="quotationRange">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="bodily_injury" id="bodily_injury">
                                        ...
                                        <option value="{{$amount->amount}}">₱{{number_format($amount->amount, 2)}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="property_damage" id="property_damage">
                                        ...
                                        @foreach($bi_amounts as $amount)
                                        <option value="{{$amount->amount}}">₱{{number_format($amount->amount, 2)}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                <input type="radio" class="btn-check" name="aon" id="btn-radio-basic-1"
                                    autocomplete="off" value="With Acts of Nature" checked>
                                <label for="btn-radio-basic-1" type="button" class="btn product-radio">With Acts
                                    of
                                    Nature</label>
                                <input type="radio" class="btn-check" name="aon" id="btn-radio-basic-2"
                                    autocomplete="off" value="Without Acts of Nature">
                                <label for="btn-radio-basic-2" type="button" class="btn product-radio">Without
                                    Acts
                                    of
                                    Nature</label>
                            </div>
                            <div class="col-12 mb-3">
                                <input type="radio" class="btn-check" name="rscc" id="btn-radio-basic-3"
                                    autocomplete="off" value="With RSCC">
                                ...
                                <input type="radio" class="btn-check" name="rscc" id="btn-radio-basic-4"
                                    autocomplete="off" value="Without RSCC" checked>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control accessory_value"
                                                    name="accessory_value[]" id="accessory_value" placeholder="Enter value">
...
<script>
    $(document).ready(function () {
        ...
        $('.saveDraft').click(function (e) {
            ...
            var source_of_income = '{{$data->source_of_income}}';
            ...
            var perm_address = '{{$data->perm_address}}';
            var perm_province = '{{$data->perm_province}}';
            var perm_city = '{{$data->perm_city}}';
            var perm_barangay = '{{$data->perm_barangay}}';
            var perm_zip_code = '{{$data->perm_zip_code}}';
                    ...
                    success: function (response) {
                        if (response.message === 'success') {
                            window.location.href =
                                "{{ url('/quotation/get-a-quote/quote/')}}" +
                                '/{{$data->trans_no}}';
                        }
                    }
                })
