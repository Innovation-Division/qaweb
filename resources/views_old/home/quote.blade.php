...
<div class="container batch-container">
    ...
    <form method="post" action="{{ url('/quotation/get-a-quote/second-page') }}" enctype="multipart/form-data"
        id="quotationForm">
        @csrf
        {{method_field('GET')}}
        <div class="row mb-3">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-end">
                        <button class="batch-button batch-button-secondary saveDraft" type="button"><svg
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mb-2">
                                    <input type="radio" class="btn-check" name="product" id="btn-radio-basic-1"
                                        autocomplete="off" value="Auto Excel Plus Insurance" checked>
                                    <label for="btn-radio-basic-1" type="button" class="btn product-radio  mb-2">Auto Excel
                                        Plus Insurance</label>
                                    <input type="radio" class="btn-check" name="product" id="btn-radio-basic-2"
                                        autocomplete="off" value="CTPL" disabled>
                                    <label for="btn-radio-basic-2" type="button" class="btn product-radio mb-2">CTPL</label>
                                    <input type="radio" class="btn-check" name="product" id="btn-radio-basic-3"
                                        autocomplete="off" value="COVID-19 Assist+" disabled>
                                    <label for="btn-radio-basic-3" type="button" class="btn product-radio mb-2">COVID-19
                                        Assist+</label>
                                    ...
                                    <label for="btn-radio-basic-4" type="button"
                                        class="btn product-radio mb-2">Pro-Tech</label>
                                    <input type="radio" class="btn-check" name="product" id="btn-radio-basic-5"
                                        autocomplete="off" value="Domestic Travel Plus" disabled>
                                    <label for="btn-radio-basic-5" type="button" class="btn product-radio mb-2">Domestic
                                        Travel
                                        Plus</label>
                                    ...
                                    <label for="btn-radio-basic-6" type="button" class="btn product-radio mb-2">International
                                        Travel Excel
                                        Plus</label>
                                </div>
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    id="first_name">
                                                <input type="hidden" value="{{$trans_no}}" id="trans_no"
                                                    name="trans_no">
                                                <input type="hidden" value="first" id="page"
                                                    name="page">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="date_of_birth"
                                                    id="date_of_birth" style="color:#929dab;">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="place_of_birth"
                                                    id="place_of_birth" placeholder="Enter your place of birth">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="source_of_income"
                                            id="source_of_income" placeholder="Enter your source of income">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" class="mb-2">ID number <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="id_number" id="id_number" placeholder="Enter your ID number">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="address" id="address" placeholder="Enter your house no., bldg name, street">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" class="mb-2">House no., Bldg name,
                                            Street <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="perm_address" id="perm_address" placeholder="Enter your house no., bldg name, street">
                                        <div class="invalid-feedback">House no., Bldg name, Street is required</div>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-3">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="perm_zip_code"
                                                    id="perm_zip_code" placeholder="Enter your zip code">
                                                <div class="invalid-feedback">Zip Code is required</div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row">
            <div class="col-lg-6 mb-3">
                <button class="batch-button batch-button-secondary col-12 saveDraft" type="button"><svg
                        xmlns="http://www.w3.org/2000/svg" width="25" height="20" fill="currentColor"
                        class="bi bi-floppy" viewBox="0 0 25 20">
                        <path d="M11 2H9v3h2z"></path>
                        <path
...
<script>
    $(document).ready(function () {
        ...
        $('.saveDraft').click(function (e) {
            ...
            if ($("#first_name").val() !== '' || $("#last_name").val() !== '' || $("#middle_name")
                .val() !== '' || $("#phone_number").val() !== '' || $("#email_address").val() !== '' ||
                $("#gender").val() !== '' || $("#civil_status").val() !== '' || $("#date_of_birth")
                .val() !== '' || $("#place_of_birth").val() !== '' || $("#occupation").val() !== '' ||
