...
@section('content')
	<div class="top-container">
            ...
            <div class="custom-banner custom-page-banner" data-uri-path="/products/products-packages/other-packages-insurance/marine-insurance">
            </div>
                        ...
                        <div class="col-sm-12 a-left">
                            <ul>
                                ...
                                <li class="category6"><a href="{{ url('/product-lines') }}" title=""> Product Lines </a> <span class="breadcrumbs-split">
                               	<li class="category6"><a href="{{ url('/marine') }}" title=""> Marine </a> <span class="breadcrumbs-split">
                                <i class="icon-keyboard_arrow_right"></i></span></li>
                                <li class="product"><strong> Truckers' Liability Plus</strong> </li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="short-description col-md-12">
                                    <div class="product-name col-md-12">
                                        <h1>
                                            Truckers' Liability Plus</h1>
                                    </div>
                                    <div class="std col-md-12 prod-desc">
                                        <p style="line-height: inherit;">
                                            Trucker’s Liability Plus enables business owners to secure their trucks, cargo as
                                            well as their drivers while in transit. This package offers the following coverage:
                                        </p>
                                        <ul id="fire_coverage">
                                            <li><i class="fa fa-check-square-o text-success"></i><span class="text-success"> Inland
                                                Transit</span> Covers the loss or damage to the interest insured during the ordinary
                                                or customary course of transit by truck, railroad or car</li>
                                            <li><i class="fa fa-check-square-o text-success"></i><span class="text-success"> Personal
                                                Accident</span> Covers truck drivers for up to Php 20,000.00</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="add-to-box col-md-12">
                    <div class="click_here_pdp">
                        <a href="#" class="produt_click_here">INQUIRE NOW</a>
                                ...
                                <div class="add-to-box col-md-12">
                                    <div class="click_here_pdp">
                                        <a href="{{ url('/product-inquiry/truckers-liability-plus') }}" dataid="42"
                                                        ...
                                                        <div class="details-area" style="height: 95px;">
                                                            <div class="product-name-wrapper abs">
                                                                ...
                                                                <h2 class="product-name">
                                                                    <a href="{{ url('/marine-insurance')}}" title="Home Excel Plus" style="font-size: 15px;color: #00539e;opacity: 0.9">
                                                                        Marine Insurance</a>
                                                                </h2>
                                                    ...
                                                    <div class="item-area box-shadow">
                                                        ...
                                                        <div class="details-area" style="height: 95px;">
                                                            <div class="product-name-wrapper abs">
                                                                ...
                                                                <h2 class="product-name">
                                                                    <a href="{{ url('/truckers-cargo-liability-insurance')}}" title="Home Excel Plus" style="font-size: 15px;color: #00539e;opacity: 0.9">
