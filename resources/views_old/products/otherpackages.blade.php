...
@section('content')
	<span style="font-family: arial"></span>
        ...
        <div class="top-container">
            ...
            <div class="custom-banner custom-page-banner" data-uri-path="/products/products-packages/other-packages-insurance">
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 a-left">
                            <ul>
                                ...
                                <li class="category5"><span style="font-family: arial;font-weight: normal;">Products</span> <span class="breadcrumbs-split"><i class="fa fa-angle-right">
                                </i></span></li>
                                <li class="category7"><span style="font-family: arial;font-weight: normal;">Product Packages</span> <span class="breadcrumbs-split">
                                    <i class="fa fa-angle-right"></i></span></li>
                                <li class="category57" style="font-family: arial;"><strong>Other Packages</strong> </li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="https://www.ucpbgen.com/quickview/index/view/id/50" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/all-in-pa-protect"
                                                title="All-In PA Protect" class="product-image" style="height: 219px;">
                                                <img id="product-collection-image-50" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/m/a/main---all-in-pa-package.jpg"
                                    ...
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/all-in-pa-protect"
                                                    title="All-In PA Protect">All-In PA Protect </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                                Affordable protection comes in handy
                                            </div>
                                        </div>
                                        <div class="actions abs">
                                            <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=50" dataid="50"
                            ...
                            <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="https://www.ucpbgen.com/quickview/index/view/id/41" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/auto-passenger-personal-accident-protect"
                                                title="Auto Passenger Personal Accident Protect" class="product-image" style="height: 219px;">
                                                <img id="product-collection-image-41" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/m/a/main---other---constituents.jpg"
                                                    alt="Auto Passenger Personal Accident Protect" width="300">
                                            </a>
                                    </div>
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/auto-passenger-personal-accident-protect"
                                                    title="Auto Passenger Personal Accident Protect">Auto Passenger Personal Accident
                                                    Protect </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                                <p>
                                        ...
                                        <div class="actions abs">
                                            <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=41" dataid="41"
                                                class="click-here inquiry col-md-12 col-sm-12 col-xs-12" title="INQUIRY">
                                                <!-- <i class="icon-cart"></i> -->
                                                <span>&nbsp;INQUIRY </span></a>
                                            <div class="clearer">
                            ...
                            <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="https://www.ucpbgen.com/quickview/index/view/id/44" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/constituents-personal-accident-insurance"
                                                title="Constituents Personal Accident Insurance" class="product-image" style="height: 219px;">
                                                <img id="product-collection-image-44" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/d/e/default.jpg"
                                                    alt="Constituents Personal Accident Insurance" width="300">
                                            </a>
                                    </div>
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/constituents-personal-accident-insurance"
                                                    title="Constituents Personal Accident Insurance">Constituents Personal Accident
                                                    Insurance </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                                <p>
                                        ...
                                        <div class="actions abs">
                                            <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=44" dataid="44"
                                                class="click-here inquiry col-md-12 col-sm-12 col-xs-12" title="INQUIRY">
                                                <!-- <i class="icon-cart"></i> -->
                                                <span>&nbsp;INQUIRY </span></a>
                                            <div class="clearer">
                            ...
                            <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="https://www.ucpbgen.com/quickview/index/view/id/47" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/dentista-segurista"
                                                title="Dentista Segurista" class="product-image" style="height: 219px;">
                                                <img id="product-collection-image-47" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/m/a/main---others---dentista.jpg"
                                                    alt="Dentista Segurista" width="300">
                                            </a>
                                    </div>
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/dentista-segurista"
                                                    title="Dentista Segurista">Dentista Segurista </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                                <p>
                                                    <span style="color: #ffffff;">---</span></p>
                                        ...
                                        <div class="actions abs">
                                            <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=47" dataid="47"
                                                class="click-here inquiry col-md-12 col-sm-12 col-xs-12" title="INQUIRY">
                                                <!-- <i class="icon-cart"></i> -->
                                                <span>&nbsp;INQUIRY </span></a>
                                            <div class="clearer">
                            ...
                            <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="https://www.ucpbgen.com/quickview/index/view/id/48" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/personal-accident-cards"
                                                title="Personal Accident Cards" class="product-image" style="height: 219px;">
                                                <img id="product-collection-image-48" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/d/e/default_1.jpg"
                                                    alt="Personal Accident Cards" width="300">
                                            </a>
                                    </div>
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/personal-accident-cards"
                                                    title="Personal Accident Cards">Personal Accident Cards </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                                <p>
                                                    <span style="color: #ffffff;">---</span></p>
                                        ...
                                        <div class="actions abs">
                                            <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=48" dataid="48"
                                                class="click-here inquiry col-md-12 col-sm-12 col-xs-12" title="INQUIRY">
                                                <!-- <i class="icon-cart"></i> -->
                                                <span>&nbsp;INQUIRY </span></a>
                                            <div class="clearer">
                            ...
                            <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="https://www.ucpbgen.com/quickview/index/view/id/45" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/petroleum-outlet-policy"
                                                title="Petroleum Outlet Policy" class="product-image" style="height: 219px;">
                                                <img id="product-collection-image-45" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/m/a/main---others---petroleum.jpg"
                                                    alt="Petroleum Outlet Policy" width="300">
                                            </a>
                                    </div>
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/petroleum-outlet-policy"
                                                    title="Petroleum Outlet Policy">Petroleum Outlet Policy </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                                <p>
                                                    <span style="color: #ffffff;">---</span></p>
                                        ...
                                        <div class="actions abs">
                                            <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=45" dataid="45"
                                                class="click-here inquiry col-md-12 col-sm-12 col-xs-12" title="INQUIRY">
                                                <!-- <i class="icon-cart"></i> -->
                                                <span>&nbsp;INQUIRY </span></a>
                                            <div class="clearer">
                            ...
                            <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="https://www.ucpbgen.com/quickview/index/view/id/43" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/truckers-cargo-liability-insurance"
                                                title="Truckers' Cargo Liability Insurance (TruCargo)" class="product-image"
                                                style="height: 219px;">
                                                <img id="product-collection-image-43" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/d/e/default_2.jpg"
                                    ...
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/truckers-cargo-liability-insurance"
                                                    title="Truckers' Cargo Liability Insurance (TruCargo)">Truckers' Cargo Liability
                                                    Insurance (TruCargo) </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                                <p>
                                                    <span style="color: #ffffff;">---</span></p>
                                        ...
                                        <div class="actions abs">
                                            <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=43" dataid="43"
                                                class="click-here inquiry col-md-12 col-sm-12 col-xs-12" title="INQUIRY">
                                                <!-- <i class="icon-cart"></i> -->
                                                <span>&nbsp;INQUIRY </span></a>
                                            <div class="clearer">
                            ...
                            <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="https://www.ucpbgen.com/quickview/index/view/id/42" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/truckers-liability-plus"
                                                title="Truckers' Liability Plus" class="product-image" style="height: 219px;">
                                                <img id="product-collection-image-42" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/d/e/default_3.jpg"
                                    ...
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/truckers-liability-plus"
                                                    title="Truckers' Liability Plus">Truckers' Liability Plus </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                                <p>
                                                    <span style="color: #ffffff;">---</span></p>
                                        ...
                                        <div class="actions abs">
                                            <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=42" dataid="42"
                                                class="click-here inquiry col-md-12 col-sm-12 col-xs-12" title="INQUIRY">
                                                <!-- <i class="icon-cart"></i> -->
                                                <span>&nbsp;INQUIRY </span></a>
                                            <div class="clearer">
                            ...
                            <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="https://www.ucpbgen.com/quickview/index/view/id/46" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/trust-receipt"
                                                title="Trust Receipt" class="product-image" style="height: 219px;">
                                                <img id="product-collection-image-46" class="landscape" src="https://cdn.ucpbgen.com/media/catalog/product/cache/1/thumbnail/300x/17f82f742ffe127f42dca9de82fb58b1/d/e/default_4.jpg"
                                    ...
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance/trust-receipt"
                                                    title="Trust Receipt">Trust Receipt </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                                <p>
                                                    <span style="color: #ffffff;">---</span></p>
                                        ...
                                        <div class="actions abs">
                                            <a href="https://www.ucpbgen.com/inquiry/index/setproductinquiry?id=46" dataid="46"
                                                class="click-here inquiry col-md-12 col-sm-12 col-xs-12" title="INQUIRY">
                                                <!-- <i class="icon-cart"></i> -->
                                                <span>&nbsp;INQUIRY </span></a>
                                            <div class="clearer">
                                ...
                                <div class="sorter">
                                    <div class="sort-by">
                                        <label for="name">
                                            Sort By:</label>
                                        <select id="name">
                                            <option value="https://www.ucpbgen.com/products/products-packages/other-packages-insurance?dir=asc&amp;order=position">
                                                Position </option>
                                            <option value="https://www.ucpbgen.com/products/products-packages/other-packages-insurance?dir=asc&amp;order=name"
                                                selected="selected">Name </option>
                                            <option value="https://www.ucpbgen.com/products/products-packages/other-packages-insurance?dir=asc&amp;order=viewproduct">
                                                Most Viewed </option>
                                        </select>
                                        <a href="https://www.ucpbgen.com/products/products-packages/other-packages-insurance?dir=desc&amp;order=name"
                                   ...
                                   <!--  <div class="limiter">
                                        <label for="limit">
                                            Show:</label>
                                        <select id="limit">
                                            <option value="https://www.ucpbgen.com/products/products-packages/other-packages-insurance?limit=100"
                                                selected="selected">100 </option>
                                            <option value="https://www.ucpbgen.com/products/products-packages/other-packages-insurance?limit=all">
                                                All </option>
                                        </select>
                                    </div> -->
                                </div>
        ...
        <a href="#" id="totop" style="display: block; bottom: 59px;"><i class="fa fa-chevron-up">
        </i></a>
                        ...
                        <div class="col-sm-6 col-xs-11 login-wrap">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in" id="epolicy" role="tabpanel">
                                    ...
                                    <input name="form_key" type="hidden" value="T1XZSQhJvUB8RPY7">
...
<div id="overlay" style="display: none;" class="finished">
</div>
