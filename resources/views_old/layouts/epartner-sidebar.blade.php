<div class="collapse navbar-collapse" id="sidebar-menu">
    <ul class="navbar-nav pt-lg-3">
            ...
            <a class="nav-link" href="{{ url('/manual-forms-sales') }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        class="icon icon-tabler icons-tabler-outline icon-tabler-notes">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path stroke="{{ (request()->is('manual-forms-sales')) ? '#E4509A' : '' }}"
                            d="M5 3m0 2a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2z" />
                        <path stroke="{{ (request()->is('manual-forms-sales')) ? '#E4509A' : '' }}" d="M9 7l6 0" />
                        <path stroke="{{ (request()->is('manual-forms-sales')) ? '#E4509A' : '' }}" d="M9 11l6 0" />
                        <path stroke="{{ (request()->is('manual-forms-sales')) ? '#E4509A' : '' }}" d="M9 15l4 0" />
                    </svg>
                </span>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/reports/motor-net-report') }}" target="_blank">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-outline icon-tabler-notes">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path stroke="{{ (request()->is('reports/motor-net-report')) ? '#E4509A' : '' }}"
                            d="M5 3m0 2a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2z" />
                        <path stroke="{{ (request()->is('reports/motor-net-report')) ? '#E4509A' : '' }}" d="M9 7l6 0" />
                        <path stroke="{{ (request()->is('reports/motor-net-report')) ? '#E4509A' : '' }}" d="M9 11l6 0" />
                        <path stroke="{{ (request()->is('reports/motor-net-report')) ? '#E4509A' : '' }}" d="M9 15l4 0" />
                    </svg>
                </span>
                <span class="nav-link-title {{ (request()->is('/reports/motor-net-report')) ? 'nav-link-title-active' : '' }}">
                Report Motor Quotation
                </span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/protech') }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-outline icon-tabler-notes">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path stroke="{{ (request()->is('protech')) ? '#E4509A' : '' }}"
                            d="M5 3m0 2a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2z" />
                        <path stroke="{{ (request()->is('protech')) ? '#E4509A' : '' }}" d="M9 7l6 0" />
                        <path stroke="{{ (request()->is('protech')) ? '#E4509A' : '' }}" d="M9 11l6 0" />
                        <path stroke="{{ (request()->is('protech')) ? '#E4509A' : '' }}" d="M9 15l4 0" />
                    </svg>
                </span>
                <span class="nav-link-title {{ (request()->is('/protech')) ? 'nav-link-title-active' : '' }}">
                        Protech Expand
                </span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/protech-report') }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-outline icon-tabler-notes">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path stroke="{{ (request()->is('protech-report')) ? '#E4509A' : '' }}"
                            d="M5 3m0 2a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2z" />
                        <path stroke="{{ (request()->is('protech-report')) ? '#E4509A' : '' }}" d="M9 7l6 0" />
                        <path stroke="{{ (request()->is('protech-report')) ? '#E4509A' : '' }}" d="M9 11l6 0" />
                        <path stroke="{{ (request()->is('protech-report')) ? '#E4509A' : '' }}" d="M9 15l4 0" />
                    </svg>
                </span>
                <span class="nav-link-title {{ (request()->is('/protech-report')) ? 'nav-link-title-active' : '' }}">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/get-quote/bonds-home') }}" target="_blank">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-outline icon-tabler-notes">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path stroke="{{ (request()->is('get-quote/bonds-home')) ? '#E4509A' : '' }}"
                            d="M5 3m0 2a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2z" />
                        <path stroke="{{ (request()->is('get-quote/bonds-home')) ? '#E4509A' : '' }}" d="M9 7l6 0" />
                        <path stroke="{{ (request()->is('get-quote/bonds-home')) ? '#E4509A' : '' }}" d="M9 11l6 0" />
                        <path stroke="{{ (request()->is('get-quote/bonds-home')) ? '#E4509A' : '' }}" d="M9 15l4 0" />
                    </svg>
                </span>
                <span class="nav-link-title {{ (request()->is('/get-quote/bonds-home')) ? 'nav-link-title-active' : '' }}">
                        Bonds Quote
                </span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/marine-home') }}" target="_blank">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-outline icon-tabler-notes">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path stroke="{{ (request()->is('marine-home')) ? '#E4509A' : '' }}"
                            d="M5 3m0 2a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2z" />
                        <path stroke="{{ (request()->is('marine-home')) ? '#E4509A' : '' }}" d="M9 7l6 0" />
                        <path stroke="{{ (request()->is('marine-home')) ? '#E4509A' : '' }}" d="M9 11l6 0" />
                        <path stroke="{{ (request()->is('marine-home')) ? '#E4509A' : '' }}" d="M9 15l4 0" />
                    </svg>
                </span>
                <span class="nav-link-title {{ (request()->is('/marine-home')) ? 'nav-link-title-active' : '' }}">
                            Marine Quote
                </span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/logout') }}">
                ...
                <span class="nav-link-title {{ (request()->is('logout')) ? 'nav-link-title-active' : '' }}">
                    Logout
                </span>
            </a>
        </li>
