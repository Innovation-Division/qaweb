...
<style>
    ...
    <div class="page">
        ...
        <header class="navbar navbar-expand-md d-none d-lg-flex d-print-none">
            <div class="d-print-none" style="border-bottom: 1px solid #dadfe5;">
                <h1 class="navbar-brand navbar-brand-autodark d-print-none">
                    <a href="{{ url('/epolicy') }}">
                        <img src="{{ URL::to('/') }}/images/COCOGEN LOGO.png" width="110" height="32" alt="Cocogen"
                            class="navbar-brand-image d-print-none" style="width: 210px; height: 100%">
                    </a>
                </h1>
            </div>
    ...
    <script>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <span id="profileImage" class="avatar avatar-sm"
                                style="background-image: url(./static/avatars/000m.jpg)"> <div id="profileImagetext"></div></span>
