                            ...
                            <!-- <li class="item">
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="{{ url('/get-quote/travel-excel-plus-insurance') }}" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="{{ url('/get-quote/travel-excel-plus-insurance') }}"
                                    ...
                                    <div class="details-area" style="height: 120px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="{{ url('/get-quote/travel-excel-plus-insurance') }}"
                                ...
                                <div class="item-area box-shadow">
                                    <div class="product-image-area">
                                        ...
                                        <a href="{{ url('/get-quote/motor-insurance') }}" class="quickview-icon">
                                            <i class="icon-export"></i><span>Quick View </span></a><a href="{{ url('/get-quote/motor-insurance/compre') }}"
                                                title="Motor" class="product-image" style="height: 180px;">
                                    ...
                                    <div class="details-area" style="height: 95px;">
                                        <div class="product-name-wrapper abs">
                                            ...
                                            <h2 class="product-name">
                                                <a href="{{ url('/get-quote/motor-insurance/compre') }}"
                                                    title="Motor">MOTOR EXCEL PLUS </a>
                                            </h2>
                                            <div class="short-description-wrapper" style="overflow-wrap: break-word;">
                                        ...
                                        <div class="actions abs">
                                    <a href="{{ url('/get-quote/motor-insurance/compre') }}" dataid="25" class="click-here inquiry col-md-12 col-sm-12 col-xs-12"
                                        title="INQUIRY">
                                        <!-- <i class="icon-cart"></i> -->
                                        <span>&nbsp;Get A Quote </span></a>
                                    <div class="clearer">
                                ...
                                <div class="item-area box-shadow">
                                    ...
                                    <div class="details-area" style="height: 95px;">
                                        <div class="product-name-wrapper abs">
                                         ...
                                         <div class="actions abs">
                                    <a href="{{ url('/get-quote/motor-insurance')  }}" dataid="25" class="click-here inquiry col-md-12 col-sm-12 col-xs-12"
                                        title="INQUIRY">
                                        <!-- <i class="icon-cart"></i> -->
                                        <span>&nbsp;Get A Quote </span></a>
                                    <div class="clearer">
