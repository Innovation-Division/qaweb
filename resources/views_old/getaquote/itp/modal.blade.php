	...
	<div class="RowDialogBody p-4 px-5">
		...
		<div class="confirm-body row-dialog-hdr-success text-center">
			...
			<table class="table_modal">
                <tr>
                    <td class="text-start">
                        <label class="rfs-1-5 rfs-md-1 fw-normal">Thank you for choosing Cocogen Travel Excel Plus - International for your trip. Before we proceed, please provide/confirm the following:</label>
                    </td>
                </tr>
            </table>
            ...
            <div class="row">
                <div class="col-md-6" style="text-align: left;">
                    <div class="form-group">
                        <label for="dateofBirth_personal_info" >Date of Birth</label> <br>

                        <input name="dateofBirth_personal_info" id="dateofBirth_personal_info"  type="text" class="form-control input-lg NoPaste validation_date_of_Birth_personal_info"  maxlength="100" placeholder="MM/DD/YYYY" autocomplete="off">
                    </div>
                </div>
            </div>
            <style type="text/css">
            ...
            <div class="row">
                <div class="col-md-6"  style="text-align: left;">
                    <div class="form-group">
                        <label for="nationality_4thpage"  style="text-align: left;">Citizenship </label>
                       <select  id="nationality_4thpage" name="nationality_4thpage" class="form-control address_mobile input-lg selectb5" data-style="input-lg  btn-white-nationality_4thpage" data-size="10"  data-live-search="true" readonly>
                                <option selected="selected" value="" style="background-color: #ffffff;font-family: arial;">-- Select --</option>
                                <option value="Filipino Citizen" style="background-color: #ffffff;font-family: arial;">Filipino Citizen</option>
                                <option value="Foreign Permanent Resident" style="background-color: #ffffff;font-family: arial;">Foreign Permanent Resident in the Philippines with Alien Certificate of Registration</option>
                                <option value="Others" style="background-color: #ffffff;font-family: arial;">Others</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <tr >
                    <td>
                        <div class="form-check d-flex_ text-left">
                            <input class="form-check-input" type="checkbox" id="chckcovid" name="chckcovid">
                            <label for="chckcovid" class="rfs-1-5 rfs-md-1 fw-normal form-check-label ml-1">I hereby certify that this trip will be for leisurely purposes only. </label>
                        </div>
                    </td>
                </tr>
		...
		<div class="confirm-btn-panel mt-4">
			<div class="btn-holder text-center">
				<button type="button" id="btnConfirm" name="btnConfirm"  class="btn btn-secondary">Confirm</button>
			</div>
		</div>
	</div>
</div>

<div id="BlockUIConfirm2" class="BlockUIConfirm confirm-modal" >
    <div class="blockui-mask"></div>
    <div class="RowDialogBody p-4 px-5">
        <div class="confirm-header row-dialog-hdr-success">
        </div>
        ...
        <div class="confirm-btn-panel mt-4">
            <div class="btn-holder text-center">
                <button type="button" id="btn_back_to_home" name="btn_back_to_home" onclick="window.location='{{ url("/") }}'" class="btn btn-secondary" >Back to Home</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
     <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p for="chckcovid">COCOGEN COVID-19 Assist+ only covers certain occupations. For more information, you may reach us at (02) 8830-6000 or client_services@cocogen.com.</p>
      </div>
       <div class="modal-footer text-center">
					...
					<div id="pop_warning2">
						<button type="button" id="btn_back_to_applicant_occupation" name="btn_back_to_applicant_occupation" class="btn btn-secondary">Check Coverage</button>
					<button type="button" id="btn_back_to_home" name="btn_back_to_home" onclick="window.location='{{ url("/") }}'" class="btn" >Back to Home</button>
					</div>
        </div>
     </div>
    </div>
...
<div class="modal fade " id="modal_PWD" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog ">
   ...
   <div class="modal-header p-0">
    ...
    <div class="modal-body">
    	<!--  <button type="button" class="btn btn-danger" data-dismiss="modal" style="float: right">&times;</button> -->
      <p><strong>Thank you for your interest in COVID-19 Assist+ </strong></p>
			<p>A Client Services representative will get back to you regarding your application. Please monitor your email for updates.</p>
    </div>
     <div class="modal-footer text-center">
          ...
          <button type="button" id="btn_back_to_applicant" name="btn_back_to_applicant" class="btn btn-secondary mb-3 mb-sm-0">Check Coverage</button>
			  	<button type="button" id="btn_back_to_home" name="btn_back_to_home" onclick="window.location='{{ url("/") }}'" class="btn btn-secondary mb-3 mb-sm-0">Back to Home</button>
       	</div>
      </div>
   </div>
  </div>
...
<div class="summary-and-confirmation-slider summary-and-confirmation-motor b5form">
    ...
    <div class="modal fade bs-example-modal-lg modal-light" id="termsConditions" tabindex="-1" role="dialog" aria-labelledby="termsConditions" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 1250px; width: 100%;">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
    ...
    <div class="modal fade bs-example-modal-lg modal-light" id="exlimitaions" tabindex="-1" role="dialog" aria-labelledby="exlimitaions" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 1250px; width: 100%;">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title heading-border rfs-2-5 rfs-md-1-3" id="exlimitaions">Exclusions and limitations</h4>
                </div>
               	 <div class="modal-body">
                    <ul>
    ...
    <div class="modal fade bs-example-modal-lg modal-light" id="packges_modal" tabindex="-1" role="dialog" aria-labelledby="packges_modal" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 1250px; width: 100%;">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                 ...
                 <div class="modal-body">
                    <div class="row">
                        <label for="Individual" style="color: #008080;"></label>
                    </div>
                    <table style="border: 1px solid #008080;width: 100%;">
                        <tbody ><strong></strong>
                            <tr>
                                <th colspan="2" style="border: 1px solid #008080;width: 100%;padding: 10px;text-align:center"><strong>STANDARD COVERAGE</strong></th>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>ECONOMY</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>ESTEEM</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>EXECUTIVE</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"> <strong>ELITE</strong></td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">A</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Accidental Death Disablement</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">10,000 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">25,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">50,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">100,000 US$</td>
                            </tr>

                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">B</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Personality Liability</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">1,000 US$  (ded. 100US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">10,000 US$ (ded. 1,000US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">20,000 US$ (ded. 2,000US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">25,000 US$ (ded. 2,000US$)</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">C</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Accidental Burial Assistance</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">500 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">1,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">2,000 US$</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">D</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Medical expenses and hospitalization abroad</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">20,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">45,000 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">50,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">100,000 US$</td>
                            </tr>
                            <tr style="border: 1px solid #008080;">
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">E</td>
                                <td style="border: 1px solid #008080;width: 25%;padding: 10px;"><strong> Travel Assistance Services</strong></td>
                            </tr>

                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">1</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Transport or repatriation in case of illness or accident</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">2</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Emergency dental care</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">400 US$</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">3</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Hospital Cash Income</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">20 US$ per day max of 10 days</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">20 US$ per day max of 10 days</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">20 US$ per day max of 10 days</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">20 US$ per day max of 10 days</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">4</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Repatriation of a family member travelling with the insured</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">5</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">6</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Escort of dependent child</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">7</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Travel of one immediate family member</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Travel cost plus up 100 US$/day maximum 1,000US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Travel cost plus up 100 US$/day maximum 1,000US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Travel cost plus up 100 US$/day maximum 1,000US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Travel cost plus up 200 US$/day maximum 2,000US$</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">8</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Emergency return home following death of a close family member</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">9</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Delivery of medicine</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">10</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Relay of urgent messages</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">11</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Long distance medical information service</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">12</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Medical referral/appointment of local medical specialist</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">13</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Connection services</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">14</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Advance of bail bond</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">1,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">1,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">1,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">2,000 US$</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">15</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Trip Cancellation</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">5,000 US$</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">16</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Trip Curtailment</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">5,000 US$</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">17</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Delay Departure</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$ (Lump Sum cash benefit per occurrence/Non-Receipted up to 100US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$ (Lump Sum cash benefit per occurrence/Non-Receipted up to 100US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$ (Lump Sum cash benefit per occurrence/Non-Receipted up to 100US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">500 US$ (Lump Sum cash benefit per occurrence/Non-Receipted up to 100US$)</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">18</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Flight Misconnection</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">400 US$</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">19</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Flight Diversion</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">400 US$</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">20</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Baggage Delay</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">40 US$  (Lump Sum cash benefit per occurrence/Non-Receipted up to 40US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">90 US$  (Lump Sum cash benefit per occurrence/Non-Receipted up to 90US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">100 US$ (Lump Sum cash benefit per occurrence/Non-Receipted up to 100US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$ (Lump Sum cash benefit per occurrence)/ Non-Receipted up to 100US$)</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">21</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Compensation for in-flight loss of checked-in baggage</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 1,200 US$ subject to limit 150 US$ for any item</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 1,200 US$ subject to limit 150 US$ for any item </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 1,200 US$ subject to limit 150 US$ for any item </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 2,400 US$ subject to limit 300 US$ for any item </td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">22</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Lost Or Stolen Baggage/Personal Belongings Not Checked-In</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 1,200 US$ subject to limit 150 US$ for any item</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 1,200 US$ subject to limit 150 US$ for any </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 1,200 US$ subject to limit 150 US$ for any </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 2,400 US$ subject to limit 300 US$ for any </td>
                            </tr>

                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">23</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Location and forwarding of baggage and personal effects</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense </td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">24</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Loss of Personal Money</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$ </td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">25</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Loss of Passport,Driving License, National Identity Card Abroad</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">250 US$ </td>
    ...
    <div class="modal fade bs-example-modal-lg modal-light" id="cruise_modal" tabindex="-1" role="dialog" aria-labelledby="cruise_modal" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 1250px; width: 100%;">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                 ...
                 <div class="modal-body">
                    <div class="row">
                        <label for="Individual" style="color: #008080;">Cruise Coverages</label>
                    </div>
                    <table style="border: 1px solid #008080;width: 100%;">
                        <tbody ><strong></strong>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;"> </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>COVERAGE</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>ECONOMY</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>ESTEEM</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>EXECUTIVE</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>ELITE</strong></td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">B</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Personal Liability</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">1,000 US$ (ded. 100US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">10,000 US$ (ded. 1,000US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">20,000 US$ (ded. 2,000US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">25,000 US$ (ded. 2,000US$)</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;"> </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Emergency Medical Repatriation</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Actual Expense</td>
                            ...
                            <tr style="border: 1px solid #008080;">
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;"> </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;"><strong>Medical Expenses</strong></td>

                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;"> </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Emergency Medical Expenses including Cabin Confinement</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">20,000 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">45,000 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">50,000 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">100,000 US$ </td>
                            ...
                            <tr style="border: 1px solid #008080;">
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;"> </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;"><strong>Travel Inconvinience</strong></td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">1</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Cruise Cancellations (cancelling the Cruise before start of the Cruise)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">5,000 US$ </td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">2</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Cruise Curtailment (Cutting your cruise trip/short)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$ </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">3,000 US$</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">5,000 US$ </td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">3</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Baggage Loss/Damage of Personal Baggage/Property - cabin checked-in items only (minimum 21 consecutive days to be considered lost)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 1,200 US$ subject to limit 150 US$ for any item </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 1,200 US$ subject to limit 150 US$ for any item </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 1,200 US$ subject to limit 150 US$ for any item </td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Up to 2,400 US$ subject to limit 300 US$ for any item </td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 5%;padding: 10px;">4</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Cruise Delays (Excluding Technical Failure, Poor Weather Conditions and Acts of Nature)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$ (Lump Sum cash benefit per occurrence/Non-Receipted up to 100US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$ (Lump Sum cash benefit per occurrence/Non-Receipted up to 100US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">200 US$ (Lump Sum cash benefit per occurrence/Non-Receipted up to 100US$)</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">500 US$ (Lump Sum cash benefit per occurrence/Non-Receipted up to 100US$)</td>
    ...
    <div class="modal fade bs-example-modal-lg modal-light" id="covid_modal" tabindex="-1" role="dialog" aria-labelledby="covid_modal" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 1250px; width: 100%;">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                 ...
                 <div class="modal-body">
                    <div class="row">
                        <label for="Individual" style="color: #008080;">Benefits for optional for COVID-19 Coverage </label>
                    </div>
                    <table style="border: 1px solid #008080;width: 100%;">
                        <tbody ><strong></strong>
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>COVID-19 Coverage</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Economy</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Esteem</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Executive</strong></td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;text-align:center"><strong>Elite</strong></td>
                            ...
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Medical expenses and hospitalilization abroad</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">US$ 20,000 for COVID-19 Cases</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">US$ 45,000 for COVID-19 Cases</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">US$ 45,000 for COVID-19 Cases</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">US$ 45,000 for COVID-19 Cases</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">Transport or repatriation in case of COVID-19 illness</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to US$ 15,000 for COVID-19 Cases</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to US$ 25,000 for COVID-19 Cases</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to US$ 25,000 for COVID-19 Cases</td>
                                <td style="border: 1px solid #008080;width: 20%;padding: 10px;">up to US$ 25,000 for COVID-19 Cases</td>
                            </tr>
                            <tr>
