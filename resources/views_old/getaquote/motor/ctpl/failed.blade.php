                    ...
                    <div class="form-group" style="margin-top: 50px;margin-bottom: 50px;margin-left: 18px;">
                        <div class="col-md-12">
                            <div class="col-md-4 col-md-offset-4">
                               <button id="SecondTabButtonBack"  name="SecondTabButtonBack" type="submit" class="form-control btn btn-primary" style="background-color: #008080;height: 40px;" value="default">Authenticate</button>
                            </div>                            
                        </div>                                
                    </div>
                        <div class="col-md-12 break-two">
