...
@foreach($cocogen_pa_quote as $cocogen_pa)
...
<input id="transno" name="transno" type="hidden" value="{{$cocogen_pa->id}}">
<input id="strstatus" name="strstatus" type="hidden" value="{{$cocogen_pa->status}}">
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="qtransno" name="qtransno" value="{{$cocogen_pa->id}}" readonly="true">
    </div>
    <label class="control-label col-sm-2" for="department">Department:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="department" name="department" value="{{$cocogen_pa->department}}" readonly="true">
    </div>    
   </div>
   <div class="form-group">
    <label class="control-label col-sm-2" for="qstatus">Status:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="qstatus" name="qstatus" value="{{$cocogen_pa->status}}" readonly="true">
    </div>    
   </div>   
   <div class="form-group">
    <label class="control-label col-sm-2" for="dtcreated">Created:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="dtcreated" name="created_at" <?php  if($cocogen_pa->created_at != '') {?> value="{{date('Y-m-d h:i A', strtotime($cocogen_pa->created_at))}}" <?php }?> readonly="true">
    </div>
    <label class="control-label col-sm-2" for="createdby">Created By:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="createdby" name="createdby" value="{{$cocogen_pa->createdby}}" readonly="true">
    </div>    
   </div>  
   @if($cocogen_pa->department != "HEAD OFFICE")
   <div class="form-group">
    <label class="control-label col-sm-2" for="dtbmreview">BM Reviewed:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="dtbmreview" name="dtbmreview" <?php  if($cocogen_pa->dt_bmreviewed != '') {?> value="{{date('Y-m-d h:i A', strtotime($cocogen_pa->dt_bmreviewed))}}" <?php }?> readonly="true">
    </div>
    <label class="control-label col-sm-2" for="bmreviewedby">BM Reviewed By:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="bmreviewedby" name="bmreviewedby" value="{{$cocogen_pa->bmreviewedby}}" readonly="true">
    </div>    
   </div>  
   @endif  
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="dtsubmitted" name="dtsubmitted" <?php  if($cocogen_pa->dt_submitted != '') {?> value="{{date('Y-m-d h:i A', strtotime($cocogen_pa->dt_submitted))}}" <?php }?> readonly="true">
    </div>
    <label class="control-label col-sm-2" for="submiitedby">Submitted By:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="submiitedby" name="submiitedby" value="{{$cocogen_pa->submittedby}}" readonly="true">
    </div>    
   </div>  
   <div class="form-group">
    <label class="control-label col-sm-2" for="dtsubmitted">For Sales Review:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="dtsubmitted" name="dtsubmitted" <?php  if($cocogen_pa->dt_forsalesreview != '') {?> value="{{date('Y-m-d h:i A', strtotime($cocogen_pa->dt_forsalesreview))}}" <?php }?> readonly="true">
    </div>
    <label class="control-label col-sm-2" for="forsalesreviewby">Forwarded By:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="forsalesreviewby" name="forsalesreviewby" value="{{$cocogen_pa->forsalesreviewby}}" readonly="true">
    </div>    
   </div>  
   <div class="form-group">
    <label class="control-label col-sm-2" for="dtuwreviewed">Underwriting Reviewed:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="dtuwreviewed" name="dtuwreviewed" <?php  if($cocogen_pa->dt_uwreviewed != '') {?> value="{{date('Y-m-d h:i A', strtotime($cocogen_pa->dt_uwreviewed))}}" <?php }?> readonly="true">
    </div>
    <label class="control-label col-sm-2" for="reviewedby">Reviewed By:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="reviewedby" name="reviewedby" value="{{$cocogen_pa->reviewedby}}" readonly="true">
    </div>    
   </div> 
   <div class="form-group">
    <label class="control-label col-sm-2" for="dtapproved">Approved:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="dtapproved" name="dtapproved" <?php  if($cocogen_pa->dt_approved != '') {?> value="{{date('Y-m-d h:i A', strtotime($cocogen_pa->dt_approved))}}" <?php }?> readonly="true">
    </div>
    <label class="control-label col-sm-2" for="approvedby">Approved By:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="approvedby" name="approvedby" value="{{$cocogen_pa->approvedby}}" readonly="true">
    </div>    
   </div> 
   @if($cocogen_pa->status == "Cancelled")
   <div class="form-group">
    <label class="control-label col-sm-2" for="dtcancelled">Cancelled:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="dtcancelled" name="dtcancelled" <?php  if($cocogen_pa->dt_cancelled != '') {?> value="{{date('Y-m-d h:i A', strtotime($cocogen_pa->dt_cancelled))}}" <?php }?> readonly="true">
    </div>
    <label class="control-label col-sm-2" for="cancelledby">Cancelled By:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="cancelledby" name="cancelledby" value="{{$cocogen_pa->cancelledby}}" readonly="true">
    </div>    
   </div>  
   @endif             
  </div>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
   <div class="form-group">
    ...
    <div class="col-sm-8">
                            <select class="form-control validate-select" name="subline" id="subline" style="text-transform: capitalize;padding: 8px;" <?php  if($readonly=="1")  {?> readonly="true" <?php }?>>
                                @foreach($cocogen_pa_subline  as $cocogen_subline)
                                <option value="{{$cocogen_subline->scode}}" data-value="{{$cocogen_subline->scode}}" @if($cocogen_pa->subline == $cocogen_subline->scode) selected="selected"@endif>{{$cocogen_subline->sdesc}}</option>
                                @endforeach
                            </select>
    </div>
  </div>     
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="incept_date" name="incept_date" placeholder="*Select Incept Date" value="{{$cocogen_pa->incept_date}}" <?php  if($readonly=="1")  {?> readonly="true" <?php }?>>
    </div>
    <label class="control-label col-sm-2" for="expiry_date">*Expiry Date:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="expiry_date" name="expiry_date" placeholder="*Select Expiry Date" value="{{$cocogen_pa->expiry_date}}" <?php  if($readonly=="1")  {?> readonly="true" <?php }?>>
    </div>    
  </div>  
    <div class="form-group">
    <label class="control-label col-sm-2" for="item_no">*Item No.:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="item_no" name="item_no" placeholder="Enter Item No." value="{{$cocogen_pa->item_no}}" <?php  if($readonly=="1")  {?> readonly="true" <?php }?>>
    </div>   
    </div>   
   ...
   <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="item_title" name="item_title" value="{{$cocogen_pa->item_title}}" placeholder="Enter Item Title" <?php  if($readonly=="1")  {?> readonly="true" <?php }?>>
    </div>
    </div>
    <div class="form-group">
    <label class="control-label col-sm-2" for="currency">*Currency:</label>
    <div class="col-sm-3">
          <select id="currency" name="currency" class="form-control" <?php  if($readonly=="1")  {?> readonly="true" <?php }?>>
          <option value="Peso" @if($cocogen_pa->currency == 'Peso') selected="selected"@endif >Peso</option>
          <option value="Dollar" @if($cocogen_pa->currency == 'Dollar') selected="selected"@endif>Dollar</option>
          </select>
  </div>    
  </div>
    <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="currency_rate" name="currency_rate" placeholder="Enter Currency Rate" value="{{$cocogen_pa->currency_rate}}" <?php  if($readonly=="1")  {?> readonly="true" <?php }?>>
    </div>   
    </div> 
    <div class="form-group">
    <label class="control-label col-sm-2" for="itm_no">*Intermediary No.:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="itm_no" name="itm_no" placeholder="Enter Intermediary No." value="{{$cocogen_pa->itm_no}}" <?php  if($readonly=="1")  {?> readonly="true" <?php } elseif(\Auth::user()->accountType == 'Agent')  {?> readonly  <?php } ?>>
    </div>   
    </div>   
   ...
   <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="beneficiary" name="beneficiary" value="{{$cocogen_pa->beneficiary}}" placeholder="Enter Beneficiary" <?php  if($readonly=="1")  {?> readonly="true" <?php }?>>
    </div>
    </div>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
   ...
   <div id="div_enrollee" name="div_enrollee">
   <div class="form-group">
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
   ...
   <div id="div_coverage" name="div_coverage"> 
   <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="ttl_sum_insured" name="ttl_sum_insured" onkeyup="javascript:this.value=Comma(this.value);" onkeypress="return isNumber(event)" value="{{number_format($cocogen_pa->sum_insured,2)}}" readonly="true">
    </div>
    <label class="control-label col-sm-2" for="ttl_premium">Total Premium:</label>
    <div class="col-sm-3">
          <input type="text" class="form-control" id="ttl_premium" name="ttl_premium" onkeyup="javascript:this.value=Comma(this.value);" onkeypress="return isNumber(event)" value="{{number_format($cocogen_pa->premium,2)}}" readonly="true">
  </div>    
  </div>
...
<div class="panel panel-primary">
  <div class="panel-body">
    ...
    <div class="row">
                ...
                @if(($cocogen_pa->status == 'Save' || $cocogen_pa->status == 'Submitted' || $cocogen_pa->status == 'For BM Review' || $cocogen_pa->status == 'For Sales Review' ) && (\Auth::user()->accountType == 'Sales' || \Auth::user()->accountType == 'Agent')) 
                ...
                @if(($cocogen_pa->status == 'Save' || $cocogen_pa->status == 'For Sales Review' ) && (\Auth::user()->accountType == 'Sales' || \Auth::user()->accountType == 'Agent'))
                ...
                @if(($cocogen_pa->status == 'For BM Review') && \Auth::user()->accountType == 'Manager')            
                ...
                @if($cocogen_pa->status != 'Approved' && $cocogen_pa->status != 'Cancelled' && (\Auth::user()->accountType == 'Sales' || \Auth::user()->accountType == 'Agent'))            
                ...
                @if(($cocogen_pa->status == 'Submitted' ||  $cocogen_pa->status == 'UW Reviewed' ||  $cocogen_pa->status == 'For BM Review') && (\Auth::user()->accountType == 'Underwriter' || \Auth::user()->accountType == 'Manager'))            
                ...
                @if($cocogen_pa->status == 'Submitted' && \Auth::user()->accountType == 'Underwriter')            
                ...
                @if($cocogen_pa->status == 'UW Reviewed' && \Auth::user()->accountType == 'Approver' && $cocogen_pa->gross_premium <= \Auth::user()->limit_to)            
                ...
                @if($cocogen_pa->status == 'Approved' && \Auth::user()->accountType == 'Approver')           
                    <a href="{{ url('/get-quote/pa-quoteapproval')}}/{{$cocogen_pa->id}}" target="_blank" class="btn btn-success" style="min-width: 100px; margin-top: 10px">Download</a>
                @endif 
...
<script>
  ...
  if (str_status == "Approved" || str_status == "Cancelled" || str_status == "UW Reviewed" || (str_type != "Sales" && str_type != "Agent"))
  {
    str_view = false;
    $('#div_enrollee').hide();
    $('#div_coverage').hide(); 
...
$('#sendform_manager').click(function(e){
   ...
   /* Submit form data using ajax*/
   $.ajax({
      url: "{{ url('/get-quote/pa-quotemanager')}}",
      method: "POST",
      data: $('#form_savecontinue').serialize(),
      dataType: 'json', 
      success: function(response){
...
$('#sendform_cancel').click(function(e){
   ...
   /* Submit form data using ajax*/
   $.ajax({
      url: "{{ url('/get-quote/pa-quotecancel')}}",
      method: "POST",
      data: $('#form_savecontinue').serialize(),
      dataType: 'json', 
      success: function(response){
...
$('#sendform_sales').click(function(e){
   ...
   /* Submit form data using ajax*/
   $.ajax({
      url: "{{ url('/get-quote/pa-quotesales')}}",
      method: "POST",
      data: $('#form_savecontinue').serialize(),
      dataType: 'json', 
      success: function(response){
  ...
  $('#sendform_review').click(function(e){
   ...
   /* Submit form data using ajax*/
   $.ajax({
      url: "{{ url('/get-quote/pa-quotereview')}}",
      method: "POST",
      data: $('#form_savecontinue').serialize(),
      dataType: 'json', 
      success: function(response){
  ...
  $('#sendform_approve').click(function(e){
   ...
   /* Submit form data using ajax*/
   $.ajax({
      url: "{{ url('/get-quote/pa-quoteapprove')}}",
      method: "POST",
      data: $('#form_savecontinue').serialize(),
      dataType: 'json', 
      success: function(response){
