            ...
            <div class="col-12 personal-div car-details-summary" style="background-color: #EFF2F4; margin-bottom: 0px;">
                <div class="row text-center">
                    ...
                    <div class="col custom-col">
                        ...
                        <p class="car-sub-details text-center">Accessory(s)</p>
                    </div>
                    <div class="col custom-col">
                        ...
                        <p class="car-sub-details text-center">Total Guard</p>
                    </div>
                    <div class="col custom-col">
                    ...
                    <div id="slider-container">
                        <div class="slide active">
                            <div class="col-lg-6 mb-4 card-price">
                                <input type="hidden" name="aon" id="aon" value="{{$carInfo->isWithAon}}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mb-4"
                                                    ...
                                                    <p class="prem-price"
                                                        ...
                                                        P{{number_format($carInfo->netPremwithAOM, 2)}}</p>
                                                </div>
                                                @if($carInfo->promoCode)
                                                <div class="col-lg-12 mb-4"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4 text-end" style="color: #DD0707; font-size: 14px;">
                                                            -{{$carInfo->promoRate}}% / P{{number_format($carInfo->netPremwithAOM * ($carInfo->promoRate / 100), 2 )}}</div>
                                                        @else 
                                                        <div class="col-4 text-end" style="color: #DD0707; font-size: 14px;">
                                                ...
                                                <div class="col-lg-12 mb-4 p-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-10 p-0">
                                                            <p style="color: #2D2727; font-weight: 600;">Extended
                                                                RoadPal Rescue</p>
                                                ...
                                                <div class="col-lg-12 mb-5 p-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-10 p-0">
                                                            <p style="color: #2D2727; font-weight: 600;">Premium with
                                                                Acts of Nature Coverage</p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mb-4"
                                                    ...
                                                    <p class="prem-price"
                                                        ...
                                                        P{{number_format($carInfo->netPrem, 2)}}</p>
                                                </div>
                                                @if($carInfo->promoCode)
                                                <div class="col-lg-12 mb-4"
                                                    style="padding: 10px 15px; background: #F6F6F6;">
                                                    <div class="row">
                                                        ...
                                                        @if($carInfo->promoType === 'P')
                                                        <div class="col-4 text-end" style="color: #DD0707; font-size: 14px;">
                                                            -{{$carInfo->promoRate}}% / P{{number_format($carInfo->netPrem * ($carInfo->promoRate / 100), 2 )}}</div>
                                                        @else 
                                                        <div class="col-4 text-end" style="color: #DD0707; font-size: 14px;">
                                                            -₱{{$carInfo->promoRate}}</div>
                                                        @endif
                                                ...
                                                <div class="col-lg-12 text-center mb-4">
                                                    <button type="button"
                                                        style="font-weight: 600; line-height: 24px; text-decoration: none; width: inherit; border: none; background: none; color: #008080;" id="withoutAON"
                                                        class="getPlan"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                            fill="currentColor" class="bi bi-arrow-right-short d-none"
                                                            viewBox="0 0 16 20">
    ...
    $(document).ready(function () {
        ...
        if('{{$transaction}}' === 'apply') {
            if ($('#aon').val() === 'yes') {
                ...
                toastr.success(
                    'You have selected <b style="font-family: Inter;">Auto Excel Plus Premium with AON</b> with a total amount of <b style="font-family: Inter;">P{{number_format($carInfo->netPremwithAOM)}}</b>',
                    'Premium with AON Selected!', {
                        timeOut: 3000
                    })
                ...
                toastr.options.progressBar = true;
                toastr.success(
                    'You have selected <b style="font-family: Inter;">Auto Excel Plus Premium without AON</b> with a total amount of <b style="font-family: Inter;">P{{number_format($carInfo->netPrem)}}</b>',
                    'Premium without AON Selected!', {
                        timeOut: 3000
                    })
        ...
        $('#withAON').click(function (e) {
            ...
            toastr.options.progressBar = true;
            toastr.success(
                'You have selected <b style="font-family: Inter;">Auto Excel Plus Premium with AON</b> with a total amount of <b style="font-family: Inter;">P{{number_format($carInfo->netPremwithAOM, 2)}}</b>',
                'Premium with AON Selected!', {
                    timeOut: 3000
                })
        ...
        $('#withoutAON').click(function (e) {
            ...
            toastr.options.progressBar = true;
            toastr.success(
                'You have selected <b style="font-family: Inter;">Auto Excel Plus Premium without AON</b> with a total amount of <b style="font-family: Inter;">P{{number_format($carInfo->netPrem, 2)}}</b>',
                'Premium without AON Selected!', {
                    timeOut: 3000
                })
