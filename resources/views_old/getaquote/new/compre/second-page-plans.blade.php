        ...
        <div class="row">
            <div class="col-12 personal-div">
                ...
                <p class="sub-head-title"
                    ...
                    Comparison of With Acts of Nature versus Without Acts of Nature</p>
            </div>
            ...
            <div class="col-12 table-div">
                ...
                <input type="hidden" name="firstAon" id="firstAon" value="{{$carInfo->isWithAon}}">
                    ...
                    <table class="table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th scope="col" style="text-align: center;" class="without-aon-class">Without AON</th>
                                <th scope="col" style="text-align: center;" class="with-aon-class">With AON</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                    ...
                    <div class="col-12 mb-5 popular-mob" style="background-color: #FFF4DA; padding: 20px 30px;">
                        <p style="color: #303030;">
                            ...
                            You have selected <span id="coveragePlan" style="font-weight: bold;">Auto Excel Plan Premium
                                with AON</span> amounting to <span id="coveragePlanPrice"
            ...
            <div class="col-12 text-center" style="background-color: #F7FCFF; height: 156px;">
                <div class="row popular-mob">
                    <div class="col-lg-6 text-center text-lg-end">
                        <button class="btn-back popular-mob" id="back"> Back</button>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        if ($("#aon").val() === 'yes') {
            ...
            $("#coveragePlan").text('Auto Excel Plan Premium with AON');
            $("#coveragePlanPrice").text('P{{number_format($carInfo->netPremwithAOM, 2)}}');
            ...
            //mobile
            $("#planSelectedMob").text('With Aon');
            $("#planSelectedMobText").text('You have selected With AON plan');
            ...
            $("#aon").val('no');
            $("#coveragePlanAlert").removeClass('d-none');
            $("#coveragePlan").text('Auto Excel Plan Premium without AON');
            $("#coveragePlanPrice").text('P{{number_format($carInfo->netPrem, 2)}}');
            ...
            $("#planSelectedMobText").text('You have selected Without AON plan');
            $('#withAONMobile').addClass('d-none');
            $('#withoutAONMobile').addClass('d-none');
            $('.web').addClass('d-none');
            $('#applyMobile').removeClass('d-none');
