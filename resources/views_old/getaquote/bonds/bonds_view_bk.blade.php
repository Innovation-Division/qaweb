        ...
        <div class="card"><!--  Experiencet -->
            ...
            <div class="form-group" id="div_collateral" name="div_collateral">
                ...
                <div class="col-md-12_ break-two"> <br> </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="fin_year">Property</label>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-12" align="center">
                                                        ...
                                                        @if (
                                                            ($cocogen_bonds->status == 'UW Reviewed' &&
                                                                \Auth::user()->accountType == 'Approver' &&
                                                                $cocogen_bonds->sum_insured <= \Auth::user()->limit_to) ||
                                                                ($cocogen_bonds->status == 'For BM Review' &&
                                                                    \Auth::user()->accountType == 'Manager' &&
                                                                    $cocogen_bonds->sum_insured <= \Auth::user()->limit_to) ||
                                                                ($cocogen_bonds->status == 'Submitted' &&
                                                                    \Auth::user()->accountType == 'Underwriter' &&
                                                                    $cocogen_bonds->sum_insured <= \Auth::user()->limit_to))
                                                            <input type="submit"
                                                                value="Approve"
                                                                id="sendform_approve"
                                                                name="sendform_approve"
                                                                class="btn btn-primary"
                                                                style="min-width: 100px; margin-top:10px"
                                                                formaction="javascript:void(0)" />
                                                        @endif

                                                        <a id="sendform_download"
                                                            href="{{ url('/get-quote/bonds-quoteapproval') }}/{{ $cocogen_bonds->id }}"
                                                            target="_blank"
                                                            class="btn btn-primary"
                                                            style="min-width: 100px; margin-top: 10px">Download</a>

                                                        <a href="{{ route('bondsquote') }}"
                                                            class="btn btn-primary"
                                                            style="min-width: 100px; margin-top: 10px">Back</a>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if ($.isEmptyObject(response.error)) {
                            console.log(response.annual_rate );
