            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select  id="acode" name="acode" class="form-control selectpicker address_mobile input-lg selectb5" data-style="input-lg  btn-white-status_4thpage" data-size="10"  data-live-search="true" >
                            ...
                            @foreach ($agent_list as $item)
                                <option value="{{ $item->code }}" @if($item->code == $cocogen_bonds->acode) selected @endif>
                                    {{ $item->code }} - {{ $item->agentname }}
                                </option>
                            @endforeach
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="agent" name="agent" placeholder="Agent/Broker*" value="{{ !empty($cocogen_bonds->agent) ? $cocogen_bonds->agent : ''  }}">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="date_incorp" name="date_incorp" placeholder="Date of Incorporation*" value="{{ ($date = strtotime($cocogen_bonds->date_incorp)) === strtotime('01/01/1970') ? '' : date('m/d/Y', $date) }}
                                ">
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <tr>
                        <input name="obligeehidden" id="obligeehidden" type="hidden" class="form-control input-lg personal_ifno_mobile" maxlength="100" value='{{ $cocogen_bonds->obligee}}'>
                        <td style='width:60%'>
                            ...
                            <select id="obligee" name="obligee" class="form-control selectpicker obligee address_mobile input-lg selectb5 principal_dropdown" data-style="input-lg btn-white-status_4thpage" data-size="10" data-live-search="true" style=" width: 70%;">
                                <option value="{{ $cocogen_bonds->obligee}}">{{ $cocogen_bonds->obligee}}</option>

                            </select>
                            @else
                            <input name="obligee" id="obligee" type="text" class="form-control input-lg personal_ifno_mobile" maxlength="100" value='{{ $cocogen_bonds->obligee}}'>
                             @endif

                        </td>
                        <td style="padding-left: 10px;"> <!-- Add space here -->
                            <input name="obligee2" id="obligee2" type="text" class="form-control input-lg personal_ifno_mobile" maxlength="100" value=''>
                        </td>
                    </tr>
                </table>
                    </div>
...
@else
     <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <label for="policy_type">Policy</label>
                            <input name="policy_type" id="policy_type" type="text" class=" policy_type form-control input-lg NoPaste personal_ifno_mobile" value="{{ @$cocogen_bonds_list[0]['policy_type']  }}" readonly>
                        </div>
                </div>
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label for="account_type">Account/Broker:</label>
                        <input name="account_type" id="account_type" type="text" class=" account_type form-control input-lg NoPaste personal_ifno_mobile"   value="{{ @$cocogen_bonds_list[0]['account_type']  }}" readonly>
                    </div>
                </div>
                            ...
                            <label for="agent">Bond Amount:</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="submit" id="sendform_calc" name="sendform_calc" class="btn btn-primary" style="height: 100%;"><span class="fa fa-calculator" aria-hidden="true"></span> Compute</button>
                                    </span>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button type="button" id="sendform_requirement" name="sendform_requirement" class="btn btn-primary" style="height: 100%;">Add</button>
                                            </span>
                                        </div>
                                        <span class="text-danger">{{ $errors->first('term_premium') }}</span>
                                    </div>
                                </div>
                                <input type="hidden" name='totalanualprem' id='totalanualprem' class='totalanualprem' value='{{ $cocogen_bonds_quote_sum}}'>
...
<div class="table-data_ table-data1 table-wrapper">
    ...
    <table id="historicaldata" class="table" style="width:90%">
                ...
                <tr>
                    ...
                    <td> 
                        <div class="form-group"><input type="text" name="in_force_policies" id="in_force_policies" class='form-control' value='{{  number_format(!empty($cocogen_bonds_tsi[0]->in_force_policies) ? $cocogen_bonds_tsi[0]->in_force_policies : 0,2)  }}'   onkeyup="javascript:this.value=Comma(this.value);" onkeypress="return isNumber(event)"></div></td>
                    <td> <div class="form-group"><input type="text" name="bonds_applied" id="bonds_applied" class='form-control'  onkeyup="javascript:this.value=Comma(this.value);"  value='{{ number_format(!empty($cocogen_bonds_tsi[0]->bonds_applied) ? $cocogen_bonds_tsi[0]->bonds_applied : 0,2) }}' readonly></div></td>
                    <td> <div class="form-group"><input type="text" name="total" id="total" class='form-control'  onkeypress="return isNumber(event)" onkeyup="javascript:this.value=Comma(this.value);" value='{{ number_format(!empty($cocogen_bonds_tsi[0]->total) ? $cocogen_bonds_tsi[0]->total : 0,2) }}' readonly></div></td>
                    <td> <div class="form-group"><input type="text" name="expired_policies" id="expired_policies" class='form-control'   onkeyup="javascript:this.value=Comma(this.value);"  onkeypress="return isNumber(event)" value='{{ number_format(!empty($cocogen_bonds_tsi[0]->expired_policies) ? $cocogen_bonds_tsi[0]->expired_policies : 0,2) }}'></div></td>

                </tr>
                <tr>
                    <td><label>TSI Treaty Share</label></td>
                    <td> <div class="form-group"><input type="text" name="in_force_policies1" id="in_force_policies1" class='form-control'  onkeypress="return isNumber(event)"  onkeyup="javascript:this.value=Comma(this.value);" value='{{ number_format(!empty($cocogen_bonds_tsi[0]->in_force_policies1) ? $cocogen_bonds_tsi[0]->in_force_policies1 : 0,2) }}'></div></td>
                    <td> <div class="form-group"><input type="text" name="bonds_applied1" id="bonds_applied1" class='form-control'  onkeypress="return isNumber(event)"  onkeyup="javascript:this.value=Comma(this.value);" value='{{ number_format(!empty($cocogen_bonds_tsi[0]->bonds_applied1) ? $cocogen_bonds_tsi[0]->bonds_applied1 : 0,2) }}'></div></td>
                    <td> <div class="form-group"><input type="text" name="total1" id="total1" class='form-control'  readonly value='{{ number_format(!empty($cocogen_bonds_tsi[0]->total1) ? $cocogen_bonds_tsi[0]->total1 : 0,2) }}'></div></td>
                    <td> <div class="form-group"><input type="text" name="expired_policies1" id="expired_policies1" class='form-control'  onkeypress="return isNumber(event)"  onkeyup="javascript:this.value=Comma(this.value);" value='{{ number_format(!empty($cocogen_bonds_tsi[0]->expired_policies1) ? $cocogen_bonds_tsi[0]->expired_policies1 : 0,2) }}'></div></td>
                </tr>
                <tr>
                    <td><label>Local Facultative</label></td>
                    <td> <div class="form-group"><input type="text" name="in_force_policies2" id="in_force_policies2" class='form-control'  onkeypress="return isNumber(event)"  onkeyup="javascript:this.value=Comma(this.value);" value='{{ number_format(!empty($cocogen_bonds_tsi[0]->in_force_policies2) ? $cocogen_bonds_tsi[0]->in_force_policies2 : 0,2) }}'></div></td>
                    <td> <div class="form-group"><input type="text" name="bonds_applied2" id="bonds_applied2" class='form-control'  onkeypress="return isNumber(event)"  onkeyup="javascript:this.value=Comma(this.value);" value='{{ number_format(!empty($cocogen_bonds_tsi[0]->bonds_applied2) ? $cocogen_bonds_tsi[0]->bonds_applied2 : 0,2) }}'></div></td>
                    <td> <div class="form-group"><input type="text" name="total2" id="total2" class='form-control'  onkeypress="return isNumber(event)" onkeyup="javascript:this.value=Comma(this.value);"readonly value='{{ number_format(!empty($cocogen_bonds_tsi[0]->total2) ? $cocogen_bonds_tsi[0]->total2 : 0,2) }}'></div></td>
                    <td> <div class="form-group"><input type="text" name="expired_policies2" id="expired_policies2" class='form-control'  onkeypress="return isNumber(event)"  onkeyup="javascript:this.value=Comma(this.value);" value='{{ number_format(!empty($cocogen_bonds_tsi[0]->expired_policies2) ? $cocogen_bonds_tsi[0]->expired_policies2 : 0,2) }}'></div></td>
                </tr>
                <tr>
                    <td><label>Total</label></td>
                    <td> <div class="form-group"><input type="text" name="total_1" id="total_1" class='form-control' readonly value='{{ number_format(!empty($cocogen_bonds_tsi[0]->total_1) ? $cocogen_bonds_tsi[0]->total_1 : 0,2) }}'></div></td>
                    <td> <div class="form-group"><input type="text" name="total_2" id="total_2" class='form-control' readonly  onkeyup="javascript:this.value=Comma(this.value);" value='{{ number_format(!empty($cocogen_bonds_tsi[0]->total_2) ? $cocogen_bonds_tsi[0]->total_2 : 0,2) }}'></div></td>
                    <td> <div class="form-group"><input type="text" name="total_3" id="total_3" class='form-control' onkeypress="return isNumber(event)" onkeyup="javascript:this.value=Comma(this.value);" readonly value='{{ number_format(!empty($cocogen_bonds_tsi[0]->total_3) ? $cocogen_bonds_tsi[0]->total_3 : 0,2) }}'></div></td>
                    <td> <div class="form-group"><input type="text" name="total_4" id="total_4" class='form-control' readonly value='{{ number_format(!empty($cocogen_bonds_tsi[0]->total_4) ? $cocogen_bonds_tsi[0]->total_4 : 0,2) }}'></div></td>
                </tr>
                </tbody>
            </table>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="form_project2" name="form_project2" method="post" enctype="multipart/form-data" action="javascript:void(0)">
                                    <div class='div_project2' id='div_project2'>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="fin_year">Project Name</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <button type="submit" id="project2_sendform" name="sendform_project2" class="btn btn-primary"><span class='fa fa-plus'></span></button>
                                    </div>
                                </div>
                                 </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="remarks-container">
                                            ...
                                            <textarea class="form-control txt_comment" name='txt_comment' id="txt_comment" rows="3"></textarea>
                                                <div class="col-md-12_ break-two"> <br> </div>
                                            <div class='col-md-4'>
                                                <button type="submit" id="sendform_comment" name="sendform_comment" class="btn btn-primary">Post</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div>
                                    <div class="panel-body">
                                     ...
                                     <!--         Sum {{ $cocogen_bonds->sum_insured   }}<br>
                                            Limit {{ \Auth::user()->limit_to }}<br>
                                            Heirs {{ \Auth::user()->limit_heirs }}<br>
                                            heirs check {{ $heirs }}<br> 
                                            AccountType {{  \Auth::user()->accountType }}
                                                   status {{  $cocogen_bonds->status }}-->
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-12" align="center">
                                                        ...
                                                        @else
                                                              @if (( $cocogen_bonds->status === 'For BM Review') && (\Auth::user()->accountType == 'Manager'))
                                                                <input type="submit" value="Submit" id="sendform_bonds" name="sendform_bonds" class="btn btn-primary" style="min-width: 100px; margin-top:10px" formaction="javascript:void(0)" />
                                                            @endif
                                                        @endif
                                                        <!-- MANAGER-->
                                                     ...
                                                     <!--    @if (( $cocogen_bonds->status === 'For BM Review') && (\Auth::user()->accountType == 'Manager'))
                                                      ...
                                                      <!--   @else
                                                        ...
                                                        @endif
                                                          <!-- SALES HO -->
                                                        {{-- @if (($cocogen_bonds->status == 'For Sales Review') && (\Auth::user()->accountType == 'Sales'))
                                                            <input type="submit" value="Save" id="sendform_save" name="sendform_save" class="btn btn-primary" style="min-width: 100px; margin-top:10px" formaction="javascript:void(0)" />
                                                        @endif --}}
                                                        @if (( $cocogen_bonds->status == 'UW Reviewed') && (\Auth::user()->accountType == 'UW Head') && $cocogen_bonds->sum_insured <= \Auth::user()->limit_to)
                                                        <input type="submit" value="Return to Underwriter" id="sendform_bonds" name="sendform_bonds" class="btn btn-primary" style="min-width: 100px; margin-top:10px" formaction="javascript:void(0)" />
                                                    @endif
                                                        ...
                                                        {{-- @if (($cocogen_bonds->status == 'For BM Review') && (
                                                            \Auth::user()->accountType == 'Sales HO' ||   \Auth::user()->accountType == 'Sales Group' || \Auth::user()->accountType == 'Specialist' || \Auth::user()->accountType == 'PEB'  || \Auth::user()->accountType == 'IMD' || \Auth::user()->accountType == 'PRES' ||
                                                            \Auth::user()->accountType == 'Underwriter' && $cocogen_bonds->sum_insured > \Auth::user()->limit_to
                                                        ))
                                                        @if ($cocogen_bonds->status != 'For Sales Review' )
                                                        ...
                                                        @endif
                                                         ...
                                                         @if (
                                                              (\Auth::user()->accountType == 'Underwriter'))
                                                                @if ($cocogen_bonds->status != 'For Sales Review' )
                                                                <input type="submit" value="For Sales Review" id="sendform_sales" name="sendform_sales" class="btn btn-primary" style="min-width: 100px; margin-top:10px" formaction="javascript:void(0)" />
                                                                @endif
                                                        @endif
                                                        ...
                                                        @if ($cocogen_bonds->status == 'Submitted' && \Auth::user()->accountType == 'Underwriter')
                                                             @if ($cocogen_bonds->status != 'Underwriter Committee Review' )
                                                        ...
                                                        @if ($cocogen_bonds->status == 'Approved' && \Auth::user()->accountType == 'Sales')
                                                            <input type="submit" value="Issued" id="sendform_issue" name="sendform_issue" class="btn btn-primary" style="min-width: 100px; margin-top:10px" formaction="javascript:void(0)" />
                                                        @endif
                                                        ...
                                                        <!-- APPROVED-->
                                                         @if($heirs == 1)
                                                            ...
                                                            @if(($cocogen_bonds->sum_insured <= \Auth::user()->limit_heirs && $cocogen_bonds->status == 'UW Reviewed' && \Auth::user()->accountType == 'UW Head') || ($cocogen_bonds->sum_insured <= \Auth::user()->limit_heirs && $cocogen_bonds->status == 'Submitted' && \Auth::user()->accountType == 'Underwriter') || ($cocogen_bonds->sum_insured <= \Auth::user()->limit_heirs && $cocogen_bonds->status == 'For BM Review' && \Auth::user()->accountType == 'Manager'))
                                                         ...
                                                         @else
                                                            ...
                                                            @if(($cocogen_bonds->sum_insured <= \Auth::user()->limit_to && $cocogen_bonds->status == 'UW Reviewed' && \Auth::user()->accountType == 'UW Head') || ($cocogen_bonds->sum_insured <= \Auth::user()->limit_to && $cocogen_bonds->status == 'Submitted' && \Auth::user()->accountType == 'Underwriter') || ($cocogen_bonds->sum_insured <= \Auth::user()->limit_to && $cocogen_bonds->status == 'For BM Review' && \Auth::user()->accountType == 'Manager'))
                                                             <input type="submit"value="Approve" id="sendform_approve" name="sendform_approve"class="btn btn-primary" style="min-width: 100px; margin-top:10px" formaction="javascript:void(0)" />
                                                            @endif
                                                        @endif


                                                            @if ($cocogen_bonds->status == 'Issued' && \Auth::user()->accountType == 'Sales')

                                                                @if( $cocogen_bonds_quote[0]->copy_quotation_to_issued !=1)
                                                                    <input type="submit" value="For Issuance" id="form_for_issueonce" name="for_issueonce" class="btn btn-primary" style="min-width: 100px; margin-top:10px" formaction="javascript:void(0)" />
                                                                @endif
                                                        @endif
...
@include('getaquote.bonds.editmodal');
<script>
    ...
    $('#field5').on('input', function() {
        ...
        // Rest of your validation and error handling code...
        ...
        $.ajax({
            ...
            method: "POST",
            data: $('#passtocontroller').serialize() + "&trans_id=" + trans_id +
                "&_token=" + csrf_token,
            dataType: 'json',
            success: function(response) {
                if ($.isEmptyObject(response.error)) {

            var bondsRequirement = parseFloat(response.bond_required);
                // $('#field1').val(response.id);
                // $('#field2').val(response.bond_type);
                $('#field3').val(bondsRequirement);
                // $('#field4').val(response.proposed_retention);
                // $('#field5').val(response.bond_amt);
                $('#field6').val(response.annual_rate);
                $('#field7').val(response.annual_premium);
                $('#field9').val(response.annual_premium_term);
...
<script>
      var trans_id = $("input[name='transno']").val();
    jQuery('#change_table').DataTable({searching: false, paging: false, info: false,
           processing: true,
           serverSide: true,
