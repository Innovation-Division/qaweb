<div class="col-md-12 break-two"><br></div>
    ...
    <div class="col-md-4 form-group">
            <label>Year</label>
            <input id="drpYear_claim_view" name="drpYear_claim_view" type="text" class="form-control input-lg" maxlength="100" value="{{ old('drpYear_claim_view') }}" >
        </div>
        <div class="col-md-4 form-group">
            <label>Brand</label>
            <input id="brand_claim_view" name="brand_claim_view" type="text" class="form-control input-lg" maxlength="100" value="{{ old('brand_claim_view') }}" >
        </div>
        <div class="col-md-4 form-group">
