<div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="col-md-12" style="margin-bottom:-15px;">
            <label id="lbl_claim_motor_pa_recovery">Is the with claim recovery?</label> 
            <input type="hidden" id="hd_claim_motor_pa_recovery" name="hd_claim_motor_pa_recovery">
        </div> 
        <div class="col-md-12 break-two"><br></div> 
        <div  class="col-md-12" >
            <button type="button" id="claim_motor_pa_recovery_yes" name="claim_motor_pa_recovery_yes" class="btn btnradiobutton" >Yes &nbsp;&nbsp;</button>
            <button type="button" id="claim_motor_pa_recovery_no" name="claim_motor_pa_recovery_no" class="btn btnradiobutton" >No &nbsp;&nbsp;</button>
        </div>
    </div>
    <div class="col-md-12 break-two"><br></div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="col-md-4 form-group">
            ...
            <input id="pa_first_name_owner" name="pa_first_name_owner" type="text" class="form-control input-lg" maxlength="100" value="{{ old('pa_first_name_owner') }}" placeholder="First Name" >
        </div>
        <div class="col-md-4 form-group">
            <label>&nbsp;</label>
            <input id="pa_middle_name_owner" name="pa_middle_name_owner" type="text" class="form-control input-lg" maxlength="100" value="{{ old('pa_middle_name_owner') }}" placeholder="Middle Name" >
        </div>
        <div class="col-md-4 form-group">
            <label>&nbsp;</label>
            <input id="pa_last_name_owner" name="pa_last_name_owner" type="text" class="form-control input-lg" maxlength="100" value="{{ old('pa_last_name_owner') }}" placeholder="Last Name"  >
        </div>
    </div>
    <div class="col-md-12 break-two"><br></div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="col-sm-4">
                <button id="clm_pa_upload" name="clm_pa_upload" type="submit"  class="btn btn-secondary">Submit</button>
        </div>      
    </div>
