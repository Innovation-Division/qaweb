<footer class="py-0 overflow-hidden">
    <div class="bottomContentWrapper">
        <div class="container">
            <div class="row justify-content-center sitemapRow">
                <div class="col-xs-12 col-lg-11">
                    <div class="row footerContent">
                        <div class="col-xs-12 col-lg-5 infoBox">
                            <div class="inner d-flex h-100">
                                <div class="row">
                                    <div class="col-md-6 col-lg-12 footerLogo text-center">
                                        <img src="{{ asset('assets/img/logo-white.png') }}" alt="Cocogen Logo" />
                                    </div>
                                    <div class="col-md-6 col-lg-12 infoList">
                                        <ul class="px-1">
                                            <li>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="20" viewBox="0 0 14 20">
                                                    <g id="Group_174" data-name="Group 174" transform="translate(-5 -2)">
                                                        <path id="Path_14" data-name="Path 14" d="M12,2A7,7,0,0,0,5,9c0,5.25,7,13,7,13s7-7.75,7-13A7,7,0,0,0,12,2ZM7,9A5,5,0,0,1,17,9c0,2.88-2.88,7.19-5,9.88C9.92,16.21,7,11.85,7,9Z" />
                                                        <circle id="Ellipse_1" data-name="Ellipse 1" cx="2.5" cy="2.5" r="2.5" transform="translate(9.5 6.5)" />
                                                    </g>
                                                </svg>
                                                <p>Address: 22F One Corporate Center, Doña Julia Vargas Ave., cor. Meralco Ave. Ortigas Center, Pasig City 1600</p>
                                            </li>
                                            <li>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                                                    <path id="Path_20" data-name="Path 20" d="M11.99,2A10,10,0,1,0,22,12,10,10,0,0,0,11.99,2ZM12,20A8,8,0,0,1,12,4a8.126,8.126,0,0,1,6.65,3.55A7.725,7.725,0,0,1,20,12,8,8,0,0,1,12,20Zm.5-13H11v6l5.25,3.15L17,14.92l-4.5-2.67Z"
                                                        transform="translate(-2 -2)" />
                                                </svg>
                                                <p>
                                                    Office hours: Mon-Fri: 8:00 AM - 5:00 PM<br />
                                                    Chat hours: Mon-Sun: 6:00 AM - 12:00 MN<br />
                                                    *with exception on holidays
                                                </p>
                                            </li>
                                            <li>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" viewBox="0 0 16 20">
                                                    <path id="Path_12" data-name="Path 12" d="M8,16h8v2H8Zm0-4h8v2H8ZM14,2H6A2.006,2.006,0,0,0,4,4V20a2,2,0,0,0,1.99,2H18a2.006,2.006,0,0,0,2-2V8Zm4,18H6V4h7V9h5Z" transform="translate(-4 -2)" />
                                                </svg>
                                                <p>License number: 2022/26-R</p>
                                            </li>
                                            <li>
                                                <svg id="Group_23" data-name="Group 23" xmlns="http://www.w3.org/2000/svg" width="20.3" height="17.4" viewBox="0 0 20.3 17.4">
                                                    <g id="Group_22" data-name="Group 22">
                                                        <path id="Path_21" data-name="Path 21" d="M11.8,6c-.986,0-5.626.74-5.785,5.626a6.523,6.523,0,0,0,4.93-5.09,6.424,6.424,0,0,0,6.424,3.77A5.756,5.756,0,0,0,11.8,6Z" transform="translate(-1.645 -3.1)" />
                                                        <circle id="Ellipse_2" data-name="Ellipse 2" cx="1.087" cy="1.087" r="1.087" transform="translate(5.438 8.7)" />
                                                        <circle id="Ellipse_3" data-name="Ellipse 3" cx="1.087" cy="1.087" r="1.087" transform="translate(12.688 8.7)" />
                                            ...
                                            <li>
                                                ...
                                                <p>Trunkline: &#40;&#48;&#50;&#41;&#32;&#56;&#56;&#49;&#49;&#45;&#49;&#55;&#56;&#56;</p>
                                            </li>
                                            <li>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="0 0 20 16">
                                                    <path id="Path_16" data-name="Path 16" class="cls-1" d="M22,6a2.006,2.006,0,0,0-2-2H4A2.006,2.006,0,0,0,2,6V18a2.006,2.006,0,0,0,2,2H20a2.006,2.006,0,0,0,2-2ZM20,6l-8,4.99L4,6Zm0,12H4V8l8,5,8-5Z" transform="translate(-2 -4)" />
                                                </svg>
                                                <p>Email: &#099;&#108;&#105;&#101;&#110;&#116;&#095;&#115;&#101;&#114;&#118;&#105;&#099;&#101;&#115;&#064;&#099;&#111;&#099;&#111;&#103;&#101;&#110;&#046;&#099;&#111;&#109;</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-12 col-lg-7">
                            <div class="row">
                                @foreach ($cocogen_admin_main as $cocogen_admin_mains)
                                    @if ($cocogen_admin_mains->subLink == 'aboutus')
                                        <div class="col-xs-12 col-lg-3 link-list">
                                            <h5>{{ $cocogen_admin_mains->navName }}</h5>
                                            <ul class="nav flex-column">
                                                @foreach ($cocogen_admin_submain as $cocogen_admin_submains)
                                                    ...
                                                    @if ($cocogen_admin_submains->navMainID == $cocogen_admin_mains->id)
                                                        <li class="nav-item mb-2"><a href="{{ url($cocogen_admin_submains->navSubLink) }}" class="p-0">{!! $cocogen_admin_submains->navSubName !!}</a></li>
                                                    @endif
                                                @endforeach
                                                {{--  <li class="nav-item mb-2"><a href="{{ url('/news') }}" class="p-0">News Updates</a></li>  --}}
                                            </ul>
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-xs-12 col-lg-3 link-list">
                                            ...
                                            <ul class="nav flex-column">
                                                @foreach ($cocogen_admin_productlink as $cocogen_admin_productlinks)
                                                    <li class="nav-item mb-2"><a href="{{ url($cocogen_admin_productlinks->link) }}" class="p-0">{{ $cocogen_admin_productlinks->product }}</a></li>
                                                @endforeach
                                                @foreach ($cocogen_admin_submain as $cocogen_admin_submains)
                                                    @if ($cocogen_admin_submains->navMainID == $cocogen_admin_mains->id)
                                    ...
                                    @endif
                                    @if ($cocogen_admin_mains->subLink == 'services')
                                        <div class="col-xs-12 col-lg-3 link-list">
                                            <h5>{{ $cocogen_admin_mains->navName }}</h5>
                                            <ul class="nav flex-column">
                                                @foreach ($cocogen_admin_submain as $cocogen_admin_submains)
                                                    @if ($cocogen_admin_submains->navMainID == $cocogen_admin_mains->id && $cocogen_admin_submains->navSubLink)
                                                        <li class="nav-item mb-2"><a href="{{ url($cocogen_admin_submains->navSubLink) }}" class="p-0">{!! $cocogen_admin_submains->navSubName !!}</a></li>
                                                    @endif
                                                    {{-- @if ($cocogen_admin_submains->navSubLink == 'client-services') --}}
                                                    {{-- <!-- Motor Car Services --> --}}
                                                    @if (9 == $cocogen_admin_submains->id)
                                                        <li class="nav-item mb-2"><a href="{{ url('/road-pal') }}" class="p-0">BiyaHelp Mobile App</a></li>
                                                        <li class="nav-item mb-2"><a href="{{ url('/gawa-agad-program') }}" class="p-0">Gawa Agad</a></li>
                                                        <li class="nav-item mb-2"><a href="{{ url('/trip-sagip') }}" class="p-0">Trip Sagip</a></li>
                                                    @endif
                                                @endforeach
                                            </ul>
                                        </div>
                                    @endif
                                    @if ($cocogen_admin_mains->subLink == 'inquiries')
                                        <div class="col-xs-12 col-lg-3 link-list">
                                            <h5>{{ $cocogen_admin_mains->navName }}</h5>
                                            <ul class="nav flex-column">
                                                @foreach ($cocogen_admin_submain as $cocogen_admin_submains)
                                ...
                                {{-- <div class="col-xs-12 col-lg-3 link-list">
                                    <h5>Services</h5>
                                    <ul class="nav flex-column">
                                        <li class="nav-item mb-2"><a href="{{ url('/file-a-claim') }}" class="p-0">File a Claim</a></li>
                                        <li class="nav-item mb-2"><a href="{{ url('/client-services') }}" class="p-0">Client Services</a></li>
                                        <li class="nav-item mb-2"><a href="{{ url('/road-pal-rescue') }}" class="p-0">Road Pal</a></li>
                                        <li class="nav-item mb-2"><a href="{{ url('/gawa-agad-program') }}" class="p-0">Gawa Agad</a></li>
                                        <li class="nav-item mb-2"><a href="{{ url('/payment-facilities') }}" class="p-0">Payment Facilities</a></li>
                                    </ul>
                                </div> --}}
                                {{-- <div class="col-xs-12 col-lg-3 link-list">
                                    <h5>Inquiries</h5>
                                    <ul class="nav flex-column">
                                        <li class="nav-item mb-2"><a href="{{ url('/faqs') }}" class="p-0">FAQs</a></li>
                                        <li class="nav-item mb-2"><a href="{{ url('/locate-a-branch') }}" class="p-0">Locate a branch</a></li>
                                        <li class="nav-item mb-2"><a href="{{ url('/product-inquiry') }}" class="p-0">Send Inquiry</a></li>
                                        <li class="nav-item mb-2"><a href="{{ url('/faqs') }}" class="p-0">Be a Partner</a></li>
                                        <li class="nav-item mb-2"><a href="{{ url('/careers') }}" class="p-0">Careers</a></li>
                                        <li class="nav-item mb-2"><a href="{{ url('/properties') }}" class="p-0">Properties for Sale</a></li>
                                    </ul>
                                </div> --}}
                            </div>
                            <div class="row">
                                <div class="col-xs-12 socialMedia">
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a href="https://www.facebook.com/cocogenofficial" class="px-2 fblink" target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="33.957" height="33.751" viewBox="0 0 33.957 33.751">
                                                    <g id="Icon_awesome-facebook" data-name="Icon awesome-facebook" transform="translate(-0.563 -0.563)" fill="none" stroke-linejoin="round">
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="none" fill="#007a70" />
                                                    </g>
                                                </svg>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="https://twitter.com/cocogenofficial" class="px-2 twlink" target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="38.812" height="32.528" viewBox="0 0 38.812 32.528">
                                                    <path id="Icon_feather-twitter" data-name="Icon feather-twitter"
                                                        ...
                                                        transform="translate(0 -2.86)" fill="none" stroke="#007a70" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" />
                                                </svg>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="https://www.instagram.com/cocogenofficial/" class="px-2 inslink" target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="35.01" height="35.002" viewBox="0 0 35.01 35.002">
                                                    <path id="Icon_awesome-instagram" data-name="Icon awesome-instagram"
                                                        ...
                                                        transform="translate(0.005 -2.238)" fill="#007a70" />
                                                </svg>
                                            </a>
                                        </li>
                                         <li class="nav-item">
                                            <a href="https://invite.viber.com/?g2=AQBOkTEQZAOpkUvvgcnfGVcbiFpw7zfAts3GvB7LSZnW3p0tPKz%2BcXPCugT8WbDC&lang=en" class="px-2 vblink" target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="34.142" height="36.004" viewBox="0 0 34.142 36.004">
                                                    <path id="Icon_awesome-viber" data-name="Icon awesome-viber"
                                                        ...
                                                        transform="translate(-0.927 -0.003)" fill="#007a70" />
                                                </svg>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="https://www.tiktok.com/@cocogenofficial" class="px-2 ttlink" target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="30.239" height="34.506" viewBox="0 0 30.239 34.506">
                                                    <path id="Icon_simple-tiktok" data-name="Icon simple-tiktok"
                                                        ...
                                                        transform="translate(-1.369 1)" fill="none" stroke="#007a70" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                </svg>
                                            </a>
                                        </li>
                                    </ul>
    ...
    <div class="container">
        <div class="row justify-content-center copyrightRow">
            <div class="col">
                <ul class="nav justify-content-center">
                    <li class="nav-item"><a href="{{ url('/terms-and-conditions') }}">Terms and Conditions</a></li>
                    <li class="nav-item"><a href="{{ url('/customer-charter') }}">Customer Charter</a></li>
                    <li class="nav-item"><a href="{{ url('/internet-security') }}">Internet Security</a></li>
                    <li class="nav-item"><a href="{{ url('/data-privacy') }}">Data Privacy</a> </li>
                    <li class="nav-item"><a href="{{ url('/sitemap') }}">Sitemap</a></li>
                </ul>
                <p class="text-center">Copyright &copy; {{ now()->year }} Cocogen Insurance, Inc</p>
            </div>
        </div>
    </div>
</footer>
