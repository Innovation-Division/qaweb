...
const ProPlanCard = ({
    ...
    return (
        <div
            className={`border ${
                formData.quotation?.package?.package === "Pro"
                    ? "border-[#006666] bg-[#FBFAFA]"
                    : "border-[#D7DEE3] bg-[#FFFFFF]"
            } py-5 px-8 rounded-lg rounded-tl-none`}
        >
            <p className="text-[#303030] text-[23px] font-bold mb-5">Pro</p>
            ...
            <div className="flex items-center gap-4 mb-4 px-2">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[#585858] text-sm">
                        Receive <b>₱500,000.00</b> as compensation if you suffer
                        accidental bodily injury during your trip that results
            ...
            <div className="flex items-center gap-4 mb-4 px-2">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[#585858] text-sm">
                        Get <b>₱50,000.00</b> reimbursement for medical expenses
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="text-[#585858] text-sm leading-6 gap-2">
                            ...
                            <ul className="flex flex-col list-disc px-4">
                                ...
                                <li>
                                    Get <b>₱500.00</b> daily hospital benefits
            ...
            <div className="flex flex-col gap-2 mb-5">
                {formData.quotation?.package?.package === "Pro" ? (
                    ...
                    <button
                        disabled={Object.keys(proPremium).length === 0}
                        className="text-white font-medium px-5 py-[10px] w-full bg-[#008080] flex group gap-2 justify-center"
                        onClick={async () => {
                            await setFormData({
                                ...formData,
                                quotation: {
                            ...
                            handlePlanSelection("pro", proPremium.due);
                        }}
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
