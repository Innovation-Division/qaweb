...
//   errors.idNumber
// );
// console.log("✅ Debug Check Icon Conditions", {
//     idType,
//     idNumber
// });
    ...
    useImperativeHandle(ref, () => ({
      validateAndScroll: (shouldScroll = true) => {
        const newErrors = {};
        if (!idType || idType === "Select ID Type") {
          newErrors.idType = " ";
        }
    ...
    return (
        <>
           <div ref={wrapperRef} className="flex items-center justify-center w-full py-6 md:py-12">
                <h2 className="flex items-center justify-center gap-4 text-[#2D2727] text-[18px] md:text-[27px] font-bold">
                    Identification
            ...
            <div className="flex flex-col items-center justify-center py-6 md:py-6 md:max-w-[780px] w-full">
                    ...
                    <div className="flex flex-col md:flex-row gap-5 items-center justify-between mb-12 w-full">
                        <div className="flex items-center gap-6 md:basis-2/3">
                            ...
                            <div className="flex flex-col w-full">
                                <p className="text-[#2D2727] md:text-[23px] text-sm max-w-[300px] md:max-w-none break-all">
                                    {selectedImage?.name}
                                </p>
                                <p className="text-[#848A90] leading-6 md:text-base text-xs">
                        ...
                        <div className="flex justify-end md:basis-1/3 gap-2">
                            {!uploading && (
                                ...
                                >
                                    ...
                                    <span className="md:text-base text-[10px]">View</span>
                                </button>
                            )}
                            {!uploading && (
                                <button
                                ...
                                >
                                    ...
                                    <span className="md:text-base text-[10px]">Delete</span>
                                </button>
                            )}
                        </div>
                    </div>
                ...
                {selectedImage && !uploading && (
                    <div className="flex flex-col md:flex-row gap-10 mb-5 w-full">
                        <label class="flex flex-col w-full" ref={typeRef}>
                            <span
                        ...
                        <label class="flex flex-col w-full" ref={numberRef}>
                            <span
                                class={`after:content-['*'] after:ml-0.5 after:text-red-500 block md:text-[10px] text-xs text-[#848A90] px-3 ${
                                    errors.idNumber
                                        ? "text-[#DD0707]"
