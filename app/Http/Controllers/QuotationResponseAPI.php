...
class QuotationResponseAPI extends Controller
{
    public function updateResponse(Request $request)
    {
        ...
        if($SecurityCode === $request->get('SecurityCode')){
            $motor = cocogen_quotation_trans::find($request->get('transID'));
            ...
            if ($motor) {
                if($request->get('type') === "created"){
                    ...
                    $motor->policy_no = $request->get('policyNo');
                    ...
                    $cocogen_quotation_trans = cocogen_quotation_trans::where('id', '=',$request->get('transID'))->get();
                    if(count($cocogen_quotation_trans)>0){
                        $cocogen_epartnerhub_notificatons = new cocogen_epartnerhub_notificatons;
                        $cocogen_epartnerhub_notificatons->name = "Issued - ".$cocogen_quotation_trans[0]['trans_no'];
                        $cocogen_epartnerhub_notificatons->description = $cocogen_quotation_trans[0]['trans_no'] .' is issued with the policies '. $request->get('policyNo').'.';
                        $cocogen_epartnerhub_notificatons->link = 'quotation/view/' . $cocogen_quotation_trans[0]['trans_no'];
                        $cocogen_epartnerhub_notificatons->status = "Unread";
                        $cocogen_epartnerhub_notificatons->email = $cocogen_quotation_trans[0]['created_by'];
                    ...
                    if(count($cocogen_quotation_trans)>0){
                        ...
                        $motor->expiryDate = $expiry;
                        $cocogen_epartnerhub_notificatons = new cocogen_epartnerhub_notificatons;
                        $cocogen_epartnerhub_notificatons->name = "Incomplete - ".$cocogen_quotation_trans[0]['trans_no'];
                        $cocogen_epartnerhub_notificatons->description = $cocogen_quotation_trans[0]['trans_no'] .' incomplete processing in issuance.';
                        $cocogen_epartnerhub_notificatons->link = 'quotation/view/' . $cocogen_quotation_trans[0]['trans_no'];
                        $cocogen_epartnerhub_notificatons->status = "Unread";
                        $cocogen_epartnerhub_notificatons->email = $cocogen_quotation_trans[0]['created_by'];
                        $cocogen_epartnerhub_notificatons->created_at = $entrydate;
