...
!(function (t, e) {
        ...
        if (!(isNaN(d) || d <= 0)) {
            switch ((t.beginPath(), h)) {
                ...
                case "triangle":
                    ...
                    break;
                case "rectRounded":
                    (l = 0.516 * d), (r = d - l), (o = Math.cos(u + St) * r), (a = Math.sin(u + St) * r), t.arc(i - o, s - a, l, u - _t, u - kt), t.arc(i + a, s - o, l, u - kt, u), t.arc(i + o, s + a, l, u, u + kt), t.arc(i - a, s + o, l, u + kt, u + _t), t.closePath();
                    break;
                case "rect":
                    if (!c) {
    ...
    class Bs extends Ds {
        ...
        calculateLabelRotation() {
            ...
            (o = t.offset ? this.maxWidth / i : u / (i - 1)), c + 6 > o && ((o = u / (i - (t.offset ? 0.5 : 1))), (a = this.maxHeight - Is(t.grid) - e.padding - zs(t.title, this.chart.options.font)), (r = Math.sqrt(c * c + d * d)), (l = zt(Math.min(Math.asin(jt((h.highest.height + 6) / o, -1, 1)), Math.asin(jt(a / r, -1, 1)) - Math.asin(jt(d / r, -1, 1))))), (l = Math.max(s, Math.min(n, l)))), (this.labelRotation = l);
        }
    ...
    (Sn.id = "bar"), (Sn.defaults = { datasetElementType: !1, dataElementType: "bar", categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: { numbers: { type: "number", properties: ["x", "y", "base", "width", "height"] } } }), (Sn.overrides = { scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
    class Pn extends Ps {
        initialize() {
            (this.enableOptionSharing = !0), super.initialize();
        }
    ...
    (Dn.id = "doughnut"),
        (Dn.defaults = { datasetElementType: !1, dataElementType: "arc", animation: { animateRotate: !0, animateScale: !1 }, animations: { numbers: { type: "number", properties: ["circumference", "endAngle", "innerRadius", "outerRadius", "startAngle", "x", "y", "offset", "borderWidth", "spacing"] } }, cutout: "50%", rotation: 0, circumference: 360, radius: "100%", spacing: 0, indexAxis: "r" }),
    ...
    (On.id = "polarArea"),
        (On.defaults = { dataElementType: "arc", animation: { animateRotate: !0, animateScale: !0 }, animations: { numbers: { type: "number", properties: ["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"] } }, indexAxis: "r", startAngle: 0 }),
        (On.overrides = {
            aspectRatio: 1,
            plugins: {
                legend: {
        ...
        const e = Zn(t),
            ...
            o = (function (t, e, i) {
                const { enableBorderRadius: s } = t.getProps(["enableBorderRadius"]),
                    ...
                    r = t.borderSkipped,
                    l = s || U(n);
                return { topLeft: Jn(!l || r.top || r.left, o.topLeft, 0, a), topRight: Jn(!l || r.top || r.right, o.topRight, 0, a), bottomLeft: Jn(!l || r.bottom || r.left, o.bottomLeft, 0, a), bottomRight: Jn(!l || r.bottom || r.right, o.bottomRight, 0, a) };
            })(t, i / 2, s / 2);
    ...
    class Oo extends Ds {
        ...
        _drawArgs(t) {
            ...
            let l,
                ...
                c,
                d = 0;
            return this.isHorizontal() ? ((h = n(r, i, o)), (c = e + t), (l = o - i)) : ("left" === a.position ? ((h = i + t), (c = n(r, s, e)), (d = -0.5 * _t)) : ((h = o - t), (c = n(r, e, s)), (d = 0.5 * _t)), (l = s - e)), { titleX: h, titleY: c, maxWidth: l, rotation: d };
        }
        draw() {
            const t = this.ctx,
                e = this.options;
