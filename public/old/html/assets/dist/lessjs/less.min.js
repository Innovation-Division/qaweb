...
!(function (e, t) {
    ...
    var i = function (t, i, n) {
        ...
        a = { length: { m: 1, cm: 0.01, mm: 0.001, in: 0.0254, px: 0.0254 / 96, pt: 0.0254 / 72, pc: (0.0254 / 72) * 12 }, duration: { s: 1, ms: 0.001 }, angle: { rad: 1 / (2 * Math.PI), deg: 1 / 360, grad: 1 / 400, turn: 1 } },
    ...
    (c.prototype = Object.assign(new u(), {
        ...
        luma: function () {
            var e = this.rgb[0] / 255,
                t = this.rgb[1] / 255,
                i = this.rgb[2] / 255;
            return 0.2126 * (e = e <= 0.03928 ? e / 12.92 : Math.pow((e + 0.055) / 1.055, 2.4)) + 0.7152 * (t = t <= 0.03928 ? t / 12.92 : Math.pow((t + 0.055) / 1.055, 2.4)) + 0.0722 * (i = i <= 0.03928 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4));
        },
        genCSS: function (e, t) {
            t.add(this.toCSS(e));
        },
    ...
    D.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            "string" != typeof r &&
                ...
                (s = !1)),
                "font" === r && e.math === N.ALWAYS && ((n = !0), (t = e.math), (e.math = N.PARENS_DIVISION));
            try {
    ...
    K.prototype = Object.assign(new u(), {
            ...
            function i(e) {
                return e.value instanceof j && !e.parsed
                    ? ("string" == typeof e.value.value
                          ? this.parse.parseNode(e.value.value, ["value", "important"], e.value.getIndex(), e.fileInfo(), function (t, i) {
        ...
        joinSelector: function (e, t, i) {
            ...
            function a(e, t) {
                var i, n;
                if (0 !== e.length)
                    if (0 !== t.length) for (i = 0; (n = t[i]); i++) n.length > 0 ? (n[n.length - 1] = n[n.length - 1].createDerived(n[n.length - 1].elements.concat(e))) : n.push(new F(e));
                    else t.push([new F(e)]);
            }
            function l(e, t) {
    ...
    oe.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            var t,
                i = this.name;
            if ((0 === i.indexOf("@@") && (i = "@" + new oe(i.slice(1), this.getIndex(), this.fileInfo()).eval(e).value), this.evaluating)) throw { type: "Name", message: "Recursive variable definition for " + i, filename: this.fileInfo().filename, index: this.getIndex() };
            if (
                ((this.evaluating = !0),
    ...
    fe.prototype = Object.assign(new u(), {
        ...
        doEval: function (e) {
            ...
            if (this.options.inline) {
                var r = new j(this.root, 0, { filename: this.importedFilename, reference: this.path._fileInfo && this.path._fileInfo.reference }, !0, !0);
        ...
        eval: function (e) {
            ...
            for (t = 0; t < this.lookups.length; t++) {
                if (((i = this.lookups[t]), Array.isArray(n) && (n = new K([new F()], n)), "" === i)) n = n.lastDeclaration();
                    ...
                    if (("@" === i.charAt(1) && (i = "@" + new oe(i.substr(1)).eval(e).value), n.variables && (n = n.variable(i)), !n)) throw { type: "Name", message: "variable " + i + " not found", filename: this.fileInfo().filename, index: this.getIndex() };
                } else {
                    ...
                    if (!e.root) {
                        ...
                        for (i = 0; i < u.length; i++) {
                            ...
                            for (
                                ...
                                (this.foundExtends = !0), (r = s[n]).findSelfSelectors(c), (r.ruleset = e), 0 === n && (r.firstExtendOnThisSelectorPath = !0), this.allExtendsStack[this.allExtendsStack.length - 1].push(r);
                        }
        ...
        checkValidNodes: function (e, t) {
            if (e)
                for (var i = 0; i < e.length; i++) {
                    var n = e[i];
                    if (t && n instanceof Ce.Declaration && !n.variable) throw { message: "Properties must be inside selector blocks. They cannot be in the root", index: n.getIndex(), filename: n.fileInfo() && n.fileInfo().filename };
                    if (n instanceof Ce.Call) throw { message: "Function '" + n.name + "' did not return a root node", index: n.getIndex(), filename: n.fileInfo() && n.fileInfo().filename };
            ...
            return {
                ...
                parse: function (r, o, a) {
                    var l,
                        ...
                        f = null,
                        p = "";
                    if (((u = a && a.globalVars ? e.serializeVars(a.globalVars) + "\n" : ""), (c = a && a.modifyVars ? "\n" + e.serializeVars(a.modifyVars) : ""), t.pluginManager)) for (var v = t.pluginManager.getPreProcessors(), d = 0; d < v.length; d++) r = v[d].process(r, { context: t, imports: i, fileInfo: n });
                            ...
                            for (s.save(); ; ) {
                                ...
                                if ((e ? u.value && 1 == u.value.length && (g = u.value[0]) : (g = u), g && (g instanceof Ce.Variable || g instanceof Ce.Property)))
                                    if (s.$char(":")) {
                                        ...
                                        if (!e) {
                                            (f.variadic = !0), s.$char(";") && !t && (t = !0), (t ? v : d).push({ name: u.name, variadic: !0 });
                                            break;
                                        }
                                        c = !0;
    ...
    var Ze = (ze = {
        ...
        hsla: function (e, t, i, n) {
            try {
                ...
                (e = (Ke(e) % 360) / 360), (t = We(Ke(t))), (i = We(Ke(i))), (n = We(Ke(n))), (r = 2 * i - (s = i <= 0.5 ? i * (t + 1) : i + t - i * t));
    ...
    var ot = function (e, t) {
        ...
        ht = {
            ...
            isunit: ct,
            unit: function (e, t) {
                if (!(e instanceof ee)) throw { type: "Argument", message: "the first argument to unit must be a number" + (e instanceof ie ? ". Have you forgotten parenthesis?" : "") };
            ...
            return (function () {
                ...
                return (
                    (t.prototype.toCSS = function (t) {
                        ...
                        if (t.pluginManager) for (var l = t.pluginManager.getPostProcessors(), u = 0; u < l.length; u++) s.css = l[u].process(s.css, { sourceMap: n, options: t, imports: this.imports });
                            ...
                            (t.prototype.add = function (e, t, i, n) {
                                if (e) {
                                    ...
                                    if (((o = (r = e.split("\n"))[r.length - 1]), t && t.filename))
                                        if (n) for (l = 0; l < r.length; l++) this._sourceMapGenerator.addMapping({ generated: { line: this._lineNumber + l + 1, column: 0 === l ? this._column : 0 }, original: { line: s.length + l, column: 0 === l ? a.length : 0 }, source: this.normalizeFilename(t.filename) });
                        ...
                        (t.prototype.push = function (t, i, n, s, o) {
                            ...
                            if (h) {
                                ...
                                i && (d.ext = s.isPlugin ? ".js" : ".less"),
                                    s.isPlugin
                                        ? ((d.mime = "application/javascript"), d.syncImport ? (f = l.loadPluginSync(t, n.currentDirectory, d, e, h)) : (p = l.loadPlugin(t, n.currentDirectory, d, e, h)))
                                        : d.syncImport
                ...
                (s.refresh = function (t, n, r) {
                    return (
                        ...
                        new Promise(function (r, o) {
                            ...
                            (a = l = new Date()),
                                0 === (h = s.sheets.length)
                                    ? ((l = new Date()), (c = l - a), s.logger.info("Less has finished and no sheets were loaded."), r({ startTime: a, endTime: l, totalMilliseconds: c, sheets: s.sheets.length }))
                                    : m(
                                          function (t, n, f, p, v) {
