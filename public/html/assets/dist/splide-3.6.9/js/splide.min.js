    ...
    (t = function () {
        ...
        var _t = Object.freeze({
                ...
                Drag: function (u, o, e) {
                    ...
                    function z(n) {
                        var t, i, r;
                        s || p("drag"), (s = n).cancelable && ((t = O(n) - O(f)), d ? (y.translate(c + t / (L && u.is(et) ? 5 : 1)), (i = 200 < T(n) - T(f)), (r = L !== (L = A())), (i || r) && R(n), p("dragging"), (v = !0), U(n)) : ((r = I((r = e.dragMinThreshold)) ? r : { mouse: 0, touch: +r || 10 }), (d = un(t) > (j(n) ? r.touch : r.mouse)), M() && U(n)));
                    }
                    function P(n) {
                        m(h, dt, z), m(h, vt, P);
                        var t,
